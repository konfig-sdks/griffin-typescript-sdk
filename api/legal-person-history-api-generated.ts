...
// @ts-ignore
import { LegalPersonHistoryListEventsResponse } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * LegalPersonHistoryApi - axios parameter creator
 * @export
 */
export const LegalPersonHistoryApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        listEvents: async (legalPersonId: string, pageSize?: number, pageAfter?: string, pageBefore?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'legalPersonId' is not null or undefined
            assertParamExists('listEvents', 'legalPersonId', legalPersonId)
            const localVarPath = `/v0/legal-persons/{legal-person-id}/history`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v0/legal-persons/{legal-person-id}/history',
                httpMethod: 'GET'
            });
...
/**
 * LegalPersonHistoryApi - functional programming interface
 * @export
 */
export const LegalPersonHistoryApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = LegalPersonHistoryApiAxiosParamCreator(configuration)
    return {
        /**
         * Lists history of events for the given legal person.
         * @param {LegalPersonHistoryApiListEventsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listEvents(requestParameters: LegalPersonHistoryApiListEventsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LegalPersonHistoryListEventsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listEvents(requestParameters.legalPersonId, requestParameters.pageSize, requestParameters.pageAfter, requestParameters.pageBefore, options);
...
/**
 * LegalPersonHistoryApi - factory interface
 * @export
 */
export const LegalPersonHistoryApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = LegalPersonHistoryApiFp(configuration)
    return {
        /**
         * Lists history of events for the given legal person.
         * @param {LegalPersonHistoryApiListEventsRequest} requestParameters Request parameters.
         ...
         * @throws {RequiredError}
         */
        listEvents(requestParameters: LegalPersonHistoryApiListEventsRequest, options?: AxiosRequestConfig): AxiosPromise<LegalPersonHistoryListEventsResponse> {
...
/**
 * Request parameters for listEvents operation in LegalPersonHistoryApi.
 * @export
 * @interface LegalPersonHistoryApiListEventsRequest
 */
export type LegalPersonHistoryApiListEventsRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof LegalPersonHistoryApiListEvents
    */
...
/**
 * LegalPersonHistoryApiGenerated - object-oriented interface
 * @export
 * @class LegalPersonHistoryApiGenerated
 * @extends {BaseAPI}
 */
export class LegalPersonHistoryApiGenerated extends BaseAPI {
    /**
     * Lists history of events for the given legal person.
     * @param {LegalPersonHistoryApiListEventsRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof LegalPersonHistoryApiGenerated
     */
    public listEvents(requestParameters: LegalPersonHistoryApiListEventsRequest, options?: AxiosRequestConfig) {
        return LegalPersonHistoryApiFp(this.configuration).listEvents(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
