...
// @ts-ignore
import { RolesAssignMembershipRolesRequest } from '../models';
// @ts-ignore
import { RolesAssignMembershipRolesResponse } from '../models';
// @ts-ignore
import { RolesGetMembershipRolesResponse } from '../models';
// @ts-ignore
import { RolesGetRoleResponse } from '../models';
// @ts-ignore
import { RolesListAllRolesResponse } from '../models';
...
export const RolesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {RolesAssignMembershipRolesRequest} rolesAssignMembershipRolesRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        assignMembershipRoles: async (membershipId: string, rolesAssignMembershipRolesRequest: RolesAssignMembershipRolesRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'membershipId' is not null or undefined
            assertParamExists('assignMembershipRoles', 'membershipId', membershipId)
            // verify required parameter 'rolesAssignMembershipRolesRequest' is not null or undefined
            assertParamExists('assignMembershipRoles', 'rolesAssignMembershipRolesRequest', rolesAssignMembershipRolesRequest)
            const localVarPath = `/v0/memberships/{membership-id}/roles`
            ...
            requestBeforeHook({
                requestBody: rolesAssignMembershipRolesRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/v0/memberships/{membership-id}/roles',
                httpMethod: 'PUT'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(rolesAssignMembershipRolesRequest, localVarRequestOptions, configuration)
         ...
         * @summary List membership roles
         * @param {string} membershipId 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getMembershipRoles: async (membershipId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'membershipId' is not null or undefined
            assertParamExists('getMembershipRoles', 'membershipId', membershipId)
            const localVarPath = `/v0/memberships/{membership-id}/roles`
                .replace(`{${"membership-id"}}`, encodeURIComponent(String(membershipId !== undefined ? membershipId : `-membership-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
        ...
        getRole: async (roleId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v0/roles/{role-id}`
                .replace(`{${"role-id"}}`, encodeURIComponent(String(roleId !== undefined ? roleId : `-role-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        listAllRoles: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const RolesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Assigns [roles](http://docs.griffin.com) to the [membership](http://docs.griffin.com).  A 422 is served if you provide a role that is not in the [Organisations](http://docs.griffin.com) `\"available-roles\"`.
         * @summary Update role
         * @param {RolesApiAssignMembershipRolesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async assignMembershipRoles(requestParameters: RolesApiAssignMembershipRolesRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RolesAssignMembershipRolesResponse>> {
            const rolesAssignMembershipRolesRequest: RolesAssignMembershipRolesRequest = {
                role-urls: requestParameters.role-urls
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.assignMembershipRoles(requestParameters.membershipId, rolesAssignMembershipRolesRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns the [roles](http://docs.griffin.com) assigned to this [membership](http://docs.griffin.com).
         * @summary List membership roles
         * @param {RolesApiGetMembershipRolesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getMembershipRoles(requestParameters: RolesApiGetMembershipRolesRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RolesGetMembershipRolesResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getMembershipRoles(requestParameters.membershipId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Yields the Role resource.
        ...
        async getRole(requestParameters: RolesApiGetRoleRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RolesGetRoleResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getRole(requestParameters.roleId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Yields a list of all Role resources.
         ...
         * @throws {RequiredError}
         */
        async listAllRoles(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RolesListAllRolesResponse>> {
...
export const RolesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        assignMembershipRoles(requestParameters: RolesApiAssignMembershipRolesRequest, options?: AxiosRequestConfig): AxiosPromise<RolesAssignMembershipRolesResponse> {
            return localVarFp.assignMembershipRoles(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns the [roles](http://docs.griffin.com) assigned to this [membership](http://docs.griffin.com).
         * @summary List membership roles
         ...
         * @throws {RequiredError}
         */
        getMembershipRoles(requestParameters: RolesApiGetMembershipRolesRequest, options?: AxiosRequestConfig): AxiosPromise<RolesGetMembershipRolesResponse> {
            return localVarFp.getMembershipRoles(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Yields the Role resource.
         * @summary Get role
         ...
         * @throws {RequiredError}
         */
        listAllRoles(options?: AxiosRequestConfig): AxiosPromise<RolesListAllRolesResponse> {
...
/**
 * Request parameters for assignMembershipRoles operation in RolesApi.
 * @export
 * @interface RolesApiAssignMembershipRolesRequest
 */
export type RolesApiAssignMembershipRolesRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof RolesApiAssignMembershipRoles
    */
...
/**
 * Request parameters for getMembershipRoles operation in RolesApi.
 * @export
 * @interface RolesApiGetMembershipRolesRequest
 */
export type RolesApiGetMembershipRolesRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof RolesApiGetMembershipRoles
    */
    readonly membershipId: string
...
export class RolesApiGenerated extends BaseAPI {
     ...
     */
    public assignMembershipRoles(requestParameters: RolesApiAssignMembershipRolesRequest, options?: AxiosRequestConfig) {
        return RolesApiFp(this.configuration).assignMembershipRoles(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof RolesApiGenerated
     */
    public getMembershipRoles(requestParameters: RolesApiGetMembershipRolesRequest, options?: AxiosRequestConfig) {
        return RolesApiFp(this.configuration).getMembershipRoles(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof RolesApiGenerated
     */
    public listAllRoles(options?: AxiosRequestConfig) {
