...
// @ts-ignore
import { DecisionsCreateDecisionRequest } from '../models';
// @ts-ignore
import { DecisionsCreateDecisionResponse } from '../models';
// @ts-ignore
import { DecisionsListForLegalPersonResponse } from '../models';
...
export const DecisionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {DecisionsCreateDecisionRequest} decisionsCreateDecisionRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createDecision: async (legalPersonId: string, decisionsCreateDecisionRequest: DecisionsCreateDecisionRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'legalPersonId' is not null or undefined
            assertParamExists('createDecision', 'legalPersonId', legalPersonId)
            // verify required parameter 'decisionsCreateDecisionRequest' is not null or undefined
            assertParamExists('createDecision', 'decisionsCreateDecisionRequest', decisionsCreateDecisionRequest)
            const localVarPath = `/v0/legal-persons/{legal-person-id}/decisions`
            ...
            requestBeforeHook({
                requestBody: decisionsCreateDecisionRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/v0/legal-persons/{legal-person-id}/decisions',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(decisionsCreateDecisionRequest, localVarRequestOptions, configuration)
...
export const DecisionsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Creates a decision against the legal person.  The provided verification must have a `verification-status` of `checks-complete`, otherwise a 422 is served.  When a decision is successfully created, the legal person\'s `application-status` is updated accordingly.  Multiple decisions may be made against the same legal person.
         * @summary Create decision
         * @param {DecisionsApiCreateDecisionRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createDecision(requestParameters: DecisionsApiCreateDecisionRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DecisionsCreateDecisionResponse>> {
            const decisionsCreateDecisionRequest: DecisionsCreateDecisionRequest = {
                verification-url: requestParameters.verification-url,
                decision-outcome: requestParameters.decision-outcome,
                decision-notes: requestParameters.decision-notes
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createDecision(requestParameters.legalPersonId, decisionsCreateDecisionRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Lists all decisions for the given legal-person.
         * @summary List decisions
         * @param {DecisionsApiListForLegalPersonRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listForLegalPerson(requestParameters: DecisionsApiListForLegalPersonRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DecisionsListForLegalPersonResponse>> {
...
export const DecisionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createDecision(requestParameters: DecisionsApiCreateDecisionRequest, options?: AxiosRequestConfig): AxiosPromise<DecisionsCreateDecisionResponse> {
            return localVarFp.createDecision(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Lists all decisions for the given legal-person.
         * @summary List decisions
         ...
         * @throws {RequiredError}
         */
        listForLegalPerson(requestParameters: DecisionsApiListForLegalPersonRequest, options?: AxiosRequestConfig): AxiosPromise<DecisionsListForLegalPersonResponse> {
...
/**
 * Request parameters for createDecision operation in DecisionsApi.
 * @export
 * @interface DecisionsApiCreateDecisionRequest
 */
export type DecisionsApiCreateDecisionRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof DecisionsApiCreateDecision
    */
...
/**
 * Request parameters for listForLegalPerson operation in DecisionsApi.
 * @export
 * @interface DecisionsApiListForLegalPersonRequest
 */
export type DecisionsApiListForLegalPersonRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof DecisionsApiListForLegalPerson
    */
    readonly legalPersonId: string
...
/**
 * DecisionsApiGenerated - object-oriented interface
 * @export
 * @class DecisionsApiGenerated
 * @extends {BaseAPI}
 */
export class DecisionsApiGenerated extends BaseAPI {
    /**
     * Creates a decision against the legal person.  The provided verification must have a `verification-status` of `checks-complete`, otherwise a 422 is served.  When a decision is successfully created, the legal person\'s `application-status` is updated accordingly.  Multiple decisions may be made against the same legal person.
     * @summary Create decision
     * @param {DecisionsApiCreateDecisionRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof DecisionsApiGenerated
     */
    public createDecision(requestParameters: DecisionsApiCreateDecisionRequest, options?: AxiosRequestConfig) {
        return DecisionsApiFp(this.configuration).createDecision(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DecisionsApiGenerated
     */
    public listForLegalPerson(requestParameters: DecisionsApiListForLegalPersonRequest, options?: AxiosRequestConfig) {
        return DecisionsApiFp(this.configuration).listForLegalPerson(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
