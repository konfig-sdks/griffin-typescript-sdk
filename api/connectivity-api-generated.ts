 ...
 * @export
 */
export const ConnectivityApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        checkConnection: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
 ...
 * @export
 */
export const ConnectivityApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ConnectivityApiAxiosParamCreator(configuration)
    return {
        /**
         * Check your connection to the Griffin API.
         * @summary Ping
         ...
         * @throws {RequiredError}
         */
        async checkConnection(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.checkConnection(options);
 ...
 * @export
 */
export const ConnectivityApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ConnectivityApiFp(configuration)
    return {
        /**
         * Check your connection to the Griffin API.
         * @summary Ping
         ...
         * @throws {RequiredError}
         */
        checkConnection(options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.checkConnection(options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * ConnectivityApiGenerated - object-oriented interface
 * @export
 * @class ConnectivityApiGenerated
 * @extends {BaseAPI}
 */
export class ConnectivityApiGenerated extends BaseAPI {
    /**
     * Check your connection to the Griffin API.
     * @summary Ping
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ConnectivityApiGenerated
     */
    public checkConnection(options?: AxiosRequestConfig) {
        return ConnectivityApiFp(this.configuration).checkConnection(options).then((request) => request(this.axios, this.basePath));
    }
}
