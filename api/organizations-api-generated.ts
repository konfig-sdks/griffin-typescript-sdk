...
// @ts-ignore
import { OrganizationsGetDetailsResponse } from '../models';
...
export const OrganizationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getDetails: async (organizationId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'organizationId' is not null or undefined
            assertParamExists('getDetails', 'organizationId', organizationId)
            const localVarPath = `/v0/organizations/{organization-id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v0/organizations/{organization-id}',
                httpMethod: 'GET'
            });
...
export const OrganizationsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Yields the organization details
         * @summary Get organization
         * @param {OrganizationsApiGetDetailsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getDetails(requestParameters: OrganizationsApiGetDetailsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrganizationsGetDetailsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getDetails(requestParameters.organizationId, options);
...
export const OrganizationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getDetails(requestParameters: OrganizationsApiGetDetailsRequest, options?: AxiosRequestConfig): AxiosPromise<OrganizationsGetDetailsResponse> {
...
/**
 * Request parameters for getDetails operation in OrganizationsApi.
 * @export
 * @interface OrganizationsApiGetDetailsRequest
 */
export type OrganizationsApiGetDetailsRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof OrganizationsApiGetDetails
    */
...
export class OrganizationsApiGenerated extends BaseAPI {
     ...
     */
    public getDetails(requestParameters: OrganizationsApiGetDetailsRequest, options?: AxiosRequestConfig) {
        return OrganizationsApiFp(this.configuration).getDetails(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
