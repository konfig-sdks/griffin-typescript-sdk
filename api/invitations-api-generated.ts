...
// @ts-ignore
import { InvitationsSendEmailRequest } from '../models';
...
export const InvitationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {InvitationsSendEmailRequest} invitationsSendEmailRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        sendEmail: async (organizationId: string, invitationsSendEmailRequest: InvitationsSendEmailRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'organizationId' is not null or undefined
            assertParamExists('sendEmail', 'organizationId', organizationId)
            // verify required parameter 'invitationsSendEmailRequest' is not null or undefined
            assertParamExists('sendEmail', 'invitationsSendEmailRequest', invitationsSendEmailRequest)
            const localVarPath = `/v0/organizations/{organization-id}/invitations`
            ...
            requestBeforeHook({
                requestBody: invitationsSendEmailRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/v0/organizations/{organization-id}/invitations',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(invitationsSendEmailRequest, localVarRequestOptions, configuration)
...
export const InvitationsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * `POST` creates a new invitation to the organization.  Sends an email invitation to join the `organization` to the specified `email-address`.
         * @summary Create invitation
         * @param {InvitationsApiSendEmailRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async sendEmail(requestParameters: InvitationsApiSendEmailRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const invitationsSendEmailRequest: InvitationsSendEmailRequest = {
                email-address: requestParameters.email-address
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.sendEmail(requestParameters.organizationId, invitationsSendEmailRequest, options);
...
export const InvitationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        sendEmail(requestParameters: InvitationsApiSendEmailRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
...
/**
 * Request parameters for sendEmail operation in InvitationsApi.
 * @export
 * @interface InvitationsApiSendEmailRequest
 */
export type InvitationsApiSendEmailRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof InvitationsApiSendEmail
    */
...
/**
 * InvitationsApiGenerated - object-oriented interface
 * @export
 * @class InvitationsApiGenerated
 * @extends {BaseAPI}
 */
export class InvitationsApiGenerated extends BaseAPI {
    /**
     * `POST` creates a new invitation to the organization.  Sends an email invitation to join the `organization` to the specified `email-address`.
     * @summary Create invitation
     * @param {InvitationsApiSendEmailRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof InvitationsApiGenerated
     */
    public sendEmail(requestParameters: InvitationsApiSendEmailRequest, options?: AxiosRequestConfig) {
        return InvitationsApiFp(this.configuration).sendEmail(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
