...
// @ts-ignore
import { UsersGetUserResourceResponse } from '../models';
...
export const UsersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getUserResource: async (userId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'userId' is not null or undefined
            assertParamExists('getUserResource', 'userId', userId)
            const localVarPath = `/v0/users/{user-id}`
...
export const UsersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Get the User resource for the current user.
         * @summary Get user
         * @param {UsersApiGetUserResourceRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getUserResource(requestParameters: UsersApiGetUserResourceRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UsersGetUserResourceResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getUserResource(requestParameters.userId, options);
...
export const UsersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getUserResource(requestParameters: UsersApiGetUserResourceRequest, options?: AxiosRequestConfig): AxiosPromise<UsersGetUserResourceResponse> {
            return localVarFp.getUserResource(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getUserResource operation in UsersApi.
 * @export
 * @interface UsersApiGetUserResourceRequest
 */
export type UsersApiGetUserResourceRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof UsersApiGetUserResource
    */
...
export class UsersApiGenerated extends BaseAPI {
     ...
     */
    public getUserResource(requestParameters: UsersApiGetUserResourceRequest, options?: AxiosRequestConfig) {
        return UsersApiFp(this.configuration).getUserResource(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
