...
import { GriffinCustom } from "./client-custom";

export class Griffin extends GriffinCustom {
  readonly apiKeys: ApiKeysApi;
  readonly bankAccounts: BankAccountsApi;
  readonly claims: ClaimsApi;
  readonly companiesHouse: CompaniesHouseApi;
  readonly connectivity: ConnectivityApi;
  readonly decisions: DecisionsApi;
  readonly events: EventsApi;
  readonly invitations: InvitationsApi;
  readonly legalPersonHistory: LegalPersonHistoryApi;
  readonly legalPersons: LegalPersonsApi;
  readonly memberships: MembershipsApi;
  readonly navigation: NavigationApi;
  readonly organizations: OrganizationsApi;
  readonly payees: PayeesApi;
  readonly payments: PaymentsApi;
  readonly pooledAccountMembership: PooledAccountMembershipApi;
  readonly relianceOnboarding: RelianceOnboardingApi;
  ...
  constructor(configurationParameters: ConfigurationParameters) {
    ...
    this.claims = new ClaimsApi(configuration);
    this.companiesHouse = new CompaniesHouseApi(configuration);
    this.connectivity = new ConnectivityApi(configuration);
    this.decisions = new DecisionsApi(configuration);
    this.events = new EventsApi(configuration);
    this.invitations = new InvitationsApi(configuration);
    this.legalPersonHistory = new LegalPersonHistoryApi(configuration);
    this.legalPersons = new LegalPersonsApi(configuration);
    this.memberships = new MembershipsApi(configuration);
    this.navigation = new NavigationApi(configuration);
    ...
    this.pooledAccountMembership = new PooledAccountMembershipApi(configuration);
    this.relianceOnboarding = new RelianceOnboardingApi(configuration);
