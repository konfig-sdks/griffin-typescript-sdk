 ...
 * 
 * @export
 * @interface PooledAccountMembershipListLegalPersonsResponse
 */
export interface PooledAccountMembershipListLegalPersonsResponse {
    /**
     * 
     * @type {Array<PoolMember>}
     * @memberof PooledAccountMembershipListLegalPersonsResponse
     */
    'pool-members': Array<PoolMember>;
    /**
     * 
     * @type {LinksProperty}
     * @memberof PooledAccountMembershipListLegalPersonsResponse
