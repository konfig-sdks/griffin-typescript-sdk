...
import { SubjectAssociationProperty } from './subject-association-property';
...
export interface RelatedProfile {
     ...
     * @type {string}
     * @memberof RelatedProfile
     */
    'display-name': string;
    /**
     * 
     * @type {SubjectAssociationProperty}
     * @memberof RelatedProfile
     */
    'subject-association': SubjectAssociationProperty;
    /**
     * 
     * @type {Array<Claim2>}
     * @memberof RelatedProfile
