 ...
 * 
 * @export
 * @interface InitialDepositProperty2
 */
export interface InitialDepositProperty2 {
    /**
     * 
     * @type {string}
     * @memberof InitialDepositProperty2
     */
    'currency': InitialDepositProperty2CurrencyEnum;
    /**
...
type InitialDepositProperty2CurrencyEnum = 'GBP'
