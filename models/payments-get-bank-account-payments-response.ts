 ...
 * 
 * @export
 * @interface PaymentsGetBankAccountPaymentsResponse
 */
export interface PaymentsGetBankAccountPaymentsResponse {
    /**
     * 
     * @type {Array<Payment>}
     * @memberof PaymentsGetBankAccountPaymentsResponse
     */
