 ...
 * 
 * @export
 * @interface UkDomestic4
 */
export interface UkDomestic4 {
    /**
     * The name of the [account holder](http://docs.griffin.com).
     * @type {string}
     * @memberof UkDomestic4
     */
     ...
     * @memberof UkDomestic4
     */
    'account-number-code': UkDomestic4AccountNumberCodeEnum;
    /**
     ...
     * @memberof UkDomestic4
     */
    'bank-id-code': UkDomestic4BankIdCodeEnum;
    /**
     * 
     * @type {string}
     * @memberof UkDomestic4
     */
    'creditor-type': UkDomestic4CreditorTypeEnum;
}

type UkDomestic4AccountNumberCodeEnum = 'bban'
type UkDomestic4BankIdCodeEnum = 'gbdsc'
type UkDomestic4CreditorTypeEnum = 'uk-domestic'
