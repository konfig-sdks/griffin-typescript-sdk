 ...
 * 
 * @export
 * @interface BusinessAddress4
 */
export interface BusinessAddress4 {
    /**
     * 
     * @type {BusinessAddressProperty3}
     * @memberof BusinessAddress4
     */
    'business-address': BusinessAddressProperty3;
    /**
     * 
     * @type {string}
     * @memberof BusinessAddress4
     */
    'claim-type': BusinessAddress4ClaimTypeEnum;
}

type BusinessAddress4ClaimTypeEnum = 'business-address'
