...
export interface Decision {
     ...
     * @memberof Decision
     */
    'decision-outcome': DecisionDecisionOutcomeEnum;
    /**
     * Indicates if the decision was automated or made by a human.
     * @type {string}
     * @memberof Decision
     */
    'decision-maker': DecisionDecisionMakerEnum;
    /**
     ...
     * @memberof Decision
     */
    'decision-ops-user'?: DecisionDecisionOpsUserEnum;
}

type DecisionDecisionOutcomeEnum = 'accepted' | 'declined'
type DecisionDecisionMakerEnum = 'system' | 'ops-user' | 'user'
type DecisionDecisionOpsUserEnum = 'griffin-ops-user'
