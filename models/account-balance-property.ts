 ...
 * @export
 * @interface AccountBalanceProperty
 */
export interface AccountBalanceProperty {
    /**
     * 
     * @type {string}
     * @memberof AccountBalanceProperty
     */
    'currency': AccountBalancePropertyCurrencyEnum;
    /**
...
type AccountBalancePropertyCurrencyEnum = 'GBP'
