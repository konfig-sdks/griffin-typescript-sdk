 ...
 * 
 * @export
 * @interface IndividualResidence
 */
export interface IndividualResidence {
    /**
     * 
     * @type {string}
     * @memberof IndividualResidence
     */
    'street-name': string;
    /**
     * 
     ...
     * @memberof IndividualResidence
     */
    'claim-type': IndividualResidenceClaimTypeEnum;
}

type IndividualResidenceClaimTypeEnum = 'individual-residence'
