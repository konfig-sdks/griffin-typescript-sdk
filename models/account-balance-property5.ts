 ...
 * @export
 * @interface AccountBalanceProperty5
 */
export interface AccountBalanceProperty5 {
    /**
     * 
     * @type {string}
     * @memberof AccountBalanceProperty5
     */
    'currency': AccountBalanceProperty5CurrencyEnum;
    /**
...
type AccountBalanceProperty5CurrencyEnum = 'GBP'
