 ...
 * 
 * @export
 * @interface BankAddress2
 */
export interface BankAddress2 {
    /**
     * The name of the [account holder](http://docs.griffin.com).
     * @type {string}
     * @memberof BankAddress2
     */
     ...
     * @memberof BankAddress2
     */
    'bank-id-code': BankAddress2BankIdCodeEnum;
    /**
     ...
     * @memberof BankAddress2
     */
    'account-number-code': BankAddress2AccountNumberCodeEnum;
}

type BankAddress2BankIdCodeEnum = 'gbdsc'
type BankAddress2AccountNumberCodeEnum = 'bban'
