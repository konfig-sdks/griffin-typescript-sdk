 ...
 * 
 * @export
 * @interface InternationalPaymentsCountries
 */
export interface InternationalPaymentsCountries {
    /**
     * 
     * @type {Array<any>}
     * @memberof InternationalPaymentsCountries
     */
     ...
     * @memberof InternationalPaymentsCountries
     */
    'claim-type': InternationalPaymentsCountriesClaimTypeEnum;
}

type InternationalPaymentsCountriesClaimTypeEnum = 'international-payments-countries'
