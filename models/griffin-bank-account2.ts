 ...
 * 
 * @export
 * @interface GriffinBankAccount2
 */
export interface GriffinBankAccount2 {
    /**
     * Link to the bank account resource.
     * @type {string}
     * @memberof GriffinBankAccount2
     */
    'account-url': string;
    /**
     * 
     ...
     * @memberof GriffinBankAccount2
     */
    'creditor-type': GriffinBankAccount2CreditorTypeEnum;
}

type GriffinBankAccount2CreditorTypeEnum = 'griffin-bank-account'
