 ...
 * 
 * @export
 * @interface AnnualTurnover3
 */
export interface AnnualTurnover3 {
    /**
     * 
     * @type {AnnualTurnoverProperty2}
     * @memberof AnnualTurnover3
     */
    'annual-turnover': AnnualTurnoverProperty2;
    /**
     * 
     * @type {string}
     * @memberof AnnualTurnover3
     */
    'claim-type': AnnualTurnover3ClaimTypeEnum;
}

type AnnualTurnover3ClaimTypeEnum = 'annual-turnover'
