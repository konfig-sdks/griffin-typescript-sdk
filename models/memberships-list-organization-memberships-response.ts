 ...
 * 
 * @export
 * @interface MembershipsListOrganizationMembershipsResponse
 */
export interface MembershipsListOrganizationMembershipsResponse {
    /**
     * 
     * @type {Array<Membership>}
     * @memberof MembershipsListOrganizationMembershipsResponse
     */
