 ...
 * 
 * @export
 * @interface AnnualTurnover1
 */
export interface AnnualTurnover1 {
    /**
     * 
     * @type {AnnualTurnoverProperty}
     * @memberof AnnualTurnover1
     */
    'annual-turnover': AnnualTurnoverProperty;
    /**
     * 
     * @type {string}
     * @memberof AnnualTurnover1
     */
    'claim-type': AnnualTurnover1ClaimTypeEnum;
}

type AnnualTurnover1ClaimTypeEnum = 'annual-turnover'
