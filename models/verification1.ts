...
export interface Verification1 {
     ...
     * @memberof Verification1
     */
    'risk-rating'?: Verification1RiskRatingEnum;
    /**
     * 
     * @type {string}
     * @memberof Verification1
     */
    'verification-status': Verification1VerificationStatusEnum;
    /**
     * 
     * @type {string}
     * @memberof Verification1
...
type Verification1RiskRatingEnum = 'high-risk' | 'prohibited-risk' | 'medium-risk' | 'low-risk'
type Verification1VerificationStatusEnum = 'in-progress' | 'pending' | 'checks-declined' | 'checks-complete' | 'failed'
