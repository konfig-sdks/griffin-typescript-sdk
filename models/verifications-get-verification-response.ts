 ...
 * 
 * @export
 * @interface VerificationsGetVerificationResponse
 */
export interface VerificationsGetVerificationResponse {
    /**
     * A link to the [verification](http://docs.griffin.com).
     * @type {string}
     * @memberof VerificationsGetVerificationResponse
     */
     ...
     * @memberof VerificationsGetVerificationResponse
     */
    'risk-rating'?: VerificationsGetVerificationResponseRiskRatingEnum;
    /**
     * 
     * @type {string}
     * @memberof VerificationsGetVerificationResponse
     */
    'verification-status': VerificationsGetVerificationResponseVerificationStatusEnum;
    /**
     * 
     * @type {string}
     * @memberof VerificationsGetVerificationResponse
...
type VerificationsGetVerificationResponseRiskRatingEnum = 'high-risk' | 'prohibited-risk' | 'medium-risk' | 'low-risk'
type VerificationsGetVerificationResponseVerificationStatusEnum = 'in-progress' | 'pending' | 'checks-declined' | 'checks-complete' | 'failed'
