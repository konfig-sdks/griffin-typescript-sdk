 ...
 * @export
 * @interface LatestDecisionProperty3
 */
export interface LatestDecisionProperty3 {
    /**
     * A link to the [verification](http://docs.griffin.com).
     * @type {string}
     * @memberof LatestDecisionProperty3
     */
     ...
     * @memberof LatestDecisionProperty3
     */
    'decision-outcome': LatestDecisionProperty3DecisionOutcomeEnum;
    /**
     * Indicates if the decision was automated or made by a human.
     * @type {string}
     * @memberof LatestDecisionProperty3
     */
    'decision-maker': LatestDecisionProperty3DecisionMakerEnum;
    /**
     ...
     * @memberof LatestDecisionProperty3
     */
    'decision-ops-user'?: LatestDecisionProperty3DecisionOpsUserEnum;
}

type LatestDecisionProperty3DecisionOutcomeEnum = 'accepted' | 'declined'
type LatestDecisionProperty3DecisionMakerEnum = 'system' | 'ops-user' | 'user'
type LatestDecisionProperty3DecisionOpsUserEnum = 'griffin-ops-user'
