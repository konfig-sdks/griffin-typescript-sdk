 ...
 * 
 * @export
 * @interface AnnualTurnoverProperty1
 */
export interface AnnualTurnoverProperty1 {
    /**
     * 
     * @type {string}
     * @memberof AnnualTurnoverProperty1
     */
    'currency': AnnualTurnoverProperty1CurrencyEnum;
    /**
...
type AnnualTurnoverProperty1CurrencyEnum = 'GBP'
