...
import { TradingAddressProperty2 } from './trading-address-property2';

/**
 * 
 * @export
 * @interface SoleTrader2
 */
export interface SoleTrader2 {
    /**
     * 
     * @type {string}
     * @memberof SoleTrader2
     */
    'trading-name': string;
    /**
     * 
     ...
     * @memberof SoleTrader2
     */
    'trading-address': TradingAddressProperty2;
    /**
     * 
     * @type {string}
     * @memberof SoleTrader2
     */
    'claim-type': SoleTrader2ClaimTypeEnum;
}

type SoleTrader2ClaimTypeEnum = 'sole-trader'
