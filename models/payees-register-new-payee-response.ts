 ...
 * 
 * @export
 * @interface PayeesRegisterNewPayeeResponse
 */
export interface PayeesRegisterNewPayeeResponse {
    /**
     * Link to the [payee](http://docs.griffin.com).
     * @type {string}
     * @memberof PayeesRegisterNewPayeeResponse
     */
    'payee-url': string;
    /**
     * Must be a UK BBAN.
     ...
     * @memberof PayeesRegisterNewPayeeResponse
     */
    'payee-status': PayeesRegisterNewPayeeResponsePayeeStatusEnum;
    /**
...
type PayeesRegisterNewPayeeResponsePayeeStatusEnum = 'deactivated' | 'active'
