 ...
 * 
 * @export
 * @interface DebtorProperty
 */
export interface DebtorProperty {
    /**
     * Must be a UK BBAN.
     * @type {string}
     * @memberof DebtorProperty
     */
     ...
     * @memberof DebtorProperty
     */
    'account-number-code': DebtorPropertyAccountNumberCodeEnum;
    /**
     ...
     * @memberof DebtorProperty
     */
    'bank-id-code': DebtorPropertyBankIdCodeEnum;
    /**
...
type DebtorPropertyAccountNumberCodeEnum = 'bban'
type DebtorPropertyBankIdCodeEnum = 'gbdsc'
