 ...
 * 
 * @export
 * @interface IndividualIdentity1
 */
export interface IndividualIdentity1 {
    /**
     * ISO 8601 formatted date.
     * @type {string}
     * @memberof IndividualIdentity1
     */
     ...
     * @memberof IndividualIdentity1
     */
    'claim-type': IndividualIdentity1ClaimTypeEnum;
}

type IndividualIdentity1ClaimTypeEnum = 'individual-identity'
