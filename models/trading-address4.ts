 ...
 * 
 * @export
 * @interface TradingAddress4
 */
export interface TradingAddress4 {
    /**
     * 
     * @type {TradingAddressProperty7}
     * @memberof TradingAddress4
     */
    'trading-address': TradingAddressProperty7;
    /**
     * 
     * @type {string}
     * @memberof TradingAddress4
     */
    'claim-type': TradingAddress4ClaimTypeEnum;
}

type TradingAddress4ClaimTypeEnum = 'trading-address'
