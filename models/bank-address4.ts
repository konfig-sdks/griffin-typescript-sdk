 ...
 * 
 * @export
 * @interface BankAddress4
 */
export interface BankAddress4 {
    /**
     * The name of the [account holder](http://docs.griffin.com).
     * @type {string}
     * @memberof BankAddress4
     */
     ...
     * @memberof BankAddress4
     */
    'bank-id-code': BankAddress4BankIdCodeEnum;
    /**
     ...
     * @memberof BankAddress4
     */
    'account-number-code': BankAddress4AccountNumberCodeEnum;
}

type BankAddress4BankIdCodeEnum = 'gbdsc'
type BankAddress4AccountNumberCodeEnum = 'bban'
