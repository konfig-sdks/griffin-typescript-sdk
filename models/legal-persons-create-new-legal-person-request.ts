 ...
 * 
 * @export
 * @interface LegalPersonsCreateNewLegalPersonRequest
 */
export interface LegalPersonsCreateNewLegalPersonRequest {
    /**
     * A human readable label for an entity
     * @type {string}
     * @memberof LegalPersonsCreateNewLegalPersonRequest
     */
    'display-name': string;
    /**
     ...
     * @memberof LegalPersonsCreateNewLegalPersonRequest
     */
    'legal-person-type': LegalPersonsCreateNewLegalPersonRequestLegalPersonTypeEnum;
    /**
     * 
     * @type {Array<Claim>}
     * @memberof LegalPersonsCreateNewLegalPersonRequest
...
type LegalPersonsCreateNewLegalPersonRequestLegalPersonTypeEnum = 'individual' | 'corporation'
