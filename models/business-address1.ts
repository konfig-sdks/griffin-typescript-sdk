 ...
 * 
 * @export
 * @interface BusinessAddress1
 */
export interface BusinessAddress1 {
    /**
     * 
     * @type {BusinessAddressProperty}
     * @memberof BusinessAddress1
     */
    'business-address': BusinessAddressProperty;
    /**
     * 
     * @type {string}
     * @memberof BusinessAddress1
     */
    'claim-type': BusinessAddress1ClaimTypeEnum;
}

type BusinessAddress1ClaimTypeEnum = 'business-address'
