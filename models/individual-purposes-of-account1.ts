 ...
 * 
 * @export
 * @interface IndividualPurposesOfAccount1
 */
export interface IndividualPurposesOfAccount1 {
    /**
     * 
     * @type {Set<string>}
     * @memberof IndividualPurposesOfAccount1
     */
    'individual-purposes-of-account': Set<IndividualPurposesOfAccount1IndividualPurposesOfAccountEnum>;
    /**
     * 
     * @type {string}
     * @memberof IndividualPurposesOfAccount1
     */
    'claim-type': IndividualPurposesOfAccount1ClaimTypeEnum;
}

type IndividualPurposesOfAccount1IndividualPurposesOfAccountEnum = 'savings' | 'bills-and-repayment' | 'everyday-spending'
type IndividualPurposesOfAccount1ClaimTypeEnum = 'individual-purposes-of-account'
