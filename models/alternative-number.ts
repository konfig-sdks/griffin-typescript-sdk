 ...
 * 
 * @export
 * @interface AlternativeNumber
 */
export interface AlternativeNumber {
    /**
     * 
     * @type {any}
     * @memberof AlternativeNumber
     */
     ...
     * @memberof AlternativeNumber
     */
    'claim-type': AlternativeNumberClaimTypeEnum;
}

type AlternativeNumberClaimTypeEnum = 'alternative-number'
