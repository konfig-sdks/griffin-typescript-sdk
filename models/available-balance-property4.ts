 ...
 * @export
 * @interface AvailableBalanceProperty4
 */
export interface AvailableBalanceProperty4 {
    /**
     * 
     * @type {string}
     * @memberof AvailableBalanceProperty4
     */
    'currency': AvailableBalanceProperty4CurrencyEnum;
    /**
...
type AvailableBalanceProperty4CurrencyEnum = 'GBP'
