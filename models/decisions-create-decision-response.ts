 ...
 * 
 * @export
 * @interface DecisionsCreateDecisionResponse
 */
export interface DecisionsCreateDecisionResponse {
    /**
     * A link to the [verification](http://docs.griffin.com).
     * @type {string}
     * @memberof DecisionsCreateDecisionResponse
     */
     ...
     * @memberof DecisionsCreateDecisionResponse
     */
    'decision-outcome': DecisionsCreateDecisionResponseDecisionOutcomeEnum;
    /**
     * Indicates if the decision was automated or made by a human.
     * @type {string}
     * @memberof DecisionsCreateDecisionResponse
     */
    'decision-maker': DecisionsCreateDecisionResponseDecisionMakerEnum;
    /**
     ...
     * @memberof DecisionsCreateDecisionResponse
     */
    'decision-user-url'?: string;
    /**
     * Username of the [user](http://docs.griffin.com) that made the decision (if applicable).
     * @type {string}
     * @memberof DecisionsCreateDecisionResponse
     */
    'decision-user-username'?: string;
    /**
     * Indicates that an Ops user has created the decision.
     * @type {string}
     * @memberof DecisionsCreateDecisionResponse
     */
    'decision-ops-user'?: DecisionsCreateDecisionResponseDecisionOpsUserEnum;
}

type DecisionsCreateDecisionResponseDecisionOutcomeEnum = 'accepted' | 'declined'
type DecisionsCreateDecisionResponseDecisionMakerEnum = 'system' | 'ops-user' | 'user'
type DecisionsCreateDecisionResponseDecisionOpsUserEnum = 'griffin-ops-user'
