...
export interface Verification {
     ...
     * @memberof Verification
     */
    'risk-rating'?: VerificationRiskRatingEnum;
    /**
     * 
     * @type {string}
     * @memberof Verification
     */
    'verification-status': VerificationVerificationStatusEnum;
    /**
     * 
     * @type {string}
     * @memberof Verification
...
type VerificationRiskRatingEnum = 'high-risk' | 'prohibited-risk' | 'medium-risk' | 'low-risk'
type VerificationVerificationStatusEnum = 'in-progress' | 'pending' | 'checks-declined' | 'checks-complete' | 'failed'
