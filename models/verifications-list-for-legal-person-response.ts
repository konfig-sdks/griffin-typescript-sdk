...
import { LinksProperty } from './links-property';
import { Verification1 } from './verification1';

/**
 * 
 * @export
 * @interface VerificationsListForLegalPersonResponse
 */
export interface VerificationsListForLegalPersonResponse {
    /**
     * 
     * @type {Array<Verification1>}
     * @memberof VerificationsListForLegalPersonResponse
     */
    'verifications': Array<Verification1>;
    /**
     * 
     * @type {LinksProperty}
     * @memberof VerificationsListForLegalPersonResponse
