 ...
 * 
 * @export
 * @interface PersonWithSignificantControl2
 */
export interface PersonWithSignificantControl2 {
    /**
     * A contextual link to the [legal person](http://docs.griffin.com).
     * @type {string}
     * @memberof PersonWithSignificantControl2
     */
     ...
     * @memberof PersonWithSignificantControl2
     */
    'claim-type': PersonWithSignificantControl2ClaimTypeEnum;
}

type PersonWithSignificantControl2ClaimTypeEnum = 'person-with-significant-control'
