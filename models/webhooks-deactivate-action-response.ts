 ...
 * 
 * @export
 * @interface WebhooksDeactivateActionResponse
 */
export interface WebhooksDeactivateActionResponse {
    /**
     * Link to the [organization](http://docs.griffin.com).
     * @type {string}
     * @memberof WebhooksDeactivateActionResponse
     */
     ...
     * @memberof WebhooksDeactivateActionResponse
     */
    'webhook-destination-url': string;
    /**
     * Test a webhook
     * @type {string}
     * @memberof WebhooksDeactivateActionResponse
     ...
     * @memberof WebhooksDeactivateActionResponse
     */
    'activate-webhook-url': string;
    /**
     * Deactivate a webhook
     * @type {string}
     * @memberof WebhooksDeactivateActionResponse
     */
    'deactivate-webhook-url': string;
    /**
