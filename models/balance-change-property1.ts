 ...
 * @export
 * @interface BalanceChangeProperty1
 */
export interface BalanceChangeProperty1 {
    /**
     * 
     * @type {string}
     * @memberof BalanceChangeProperty1
     */
    'currency': BalanceChangeProperty1CurrencyEnum;
    /**
...
type BalanceChangeProperty1CurrencyEnum = 'GBP'
