...
import { CreditorProperty4 } from './creditor-property4';
import { DebtorProperty3 } from './debtor-property3';
import { PaymentAmountProperty4 } from './payment-amount-property4';
import { UltimateDebtorProperty3 } from './ultimate-debtor-property3';

/**
 * 
 * @export
 * @interface PaymentsGetDetailsResponse
 */
export interface PaymentsGetDetailsResponse {
    /**
     * 
     * @type {CreditorProperty4}
     * @memberof PaymentsGetDetailsResponse
     */
    'creditor': CreditorProperty4;
    /**
     * Whether the payment is moving money into or out of the account.
     * @type {string}
     * @memberof PaymentsGetDetailsResponse
     */
    'payment-direction': PaymentsGetDetailsResponsePaymentDirectionEnum;
    /**
    ...
    /**
     * 
     * @type {PaymentAmountProperty4}
     * @memberof PaymentsGetDetailsResponse
     */
    'payment-amount': PaymentAmountProperty4;
    /**
     * 
     * @type {UltimateDebtorProperty3}
     * @memberof PaymentsGetDetailsResponse
     */
    'ultimate-debtor'?: UltimateDebtorProperty3;
    /**
    ...
    /**
     * 
     * @type {DebtorProperty3}
     * @memberof PaymentsGetDetailsResponse
     */
    'debtor': DebtorProperty3;
}

type PaymentsGetDetailsResponsePaymentDirectionEnum = 'inbound-payment' | 'outbound-payment'
