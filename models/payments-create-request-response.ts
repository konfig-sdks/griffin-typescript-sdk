...
import { CreditorProperty2 } from './creditor-property2';
import { DebtorProperty1 } from './debtor-property1';
import { PaymentAmountProperty2 } from './payment-amount-property2';
import { UltimateDebtorProperty1 } from './ultimate-debtor-property1';

/**
 * 
 * @export
 * @interface PaymentsCreateRequestResponse
 */
export interface PaymentsCreateRequestResponse {
    /**
     * 
     * @type {CreditorProperty2}
     * @memberof PaymentsCreateRequestResponse
     */
    'creditor': CreditorProperty2;
    /**
     * Whether the payment is moving money into or out of the account.
     * @type {string}
     * @memberof PaymentsCreateRequestResponse
     */
    'payment-direction': PaymentsCreateRequestResponsePaymentDirectionEnum;
    /**
    ...
    /**
     * 
     * @type {PaymentAmountProperty2}
     * @memberof PaymentsCreateRequestResponse
     */
    'payment-amount': PaymentAmountProperty2;
    /**
     * 
     * @type {UltimateDebtorProperty1}
     * @memberof PaymentsCreateRequestResponse
     */
    'ultimate-debtor'?: UltimateDebtorProperty1;
    /**
     * Link to the endpoint for listing payment admissions.
     * @type {string}
     * @memberof PaymentsCreateRequestResponse
     */
    'payment-admissions-url'?: string;
    /**
    ...
    /**
     * 
     * @type {DebtorProperty1}
     * @memberof PaymentsCreateRequestResponse
     */
    'debtor': DebtorProperty1;
}

type PaymentsCreateRequestResponsePaymentDirectionEnum = 'inbound-payment' | 'outbound-payment'
