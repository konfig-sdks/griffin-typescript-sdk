 ...
 * @export
 * @interface PaymentAmountProperty2
 */
export interface PaymentAmountProperty2 {
    /**
     * 
     * @type {string}
     * @memberof PaymentAmountProperty2
     */
    'currency': PaymentAmountProperty2CurrencyEnum;
    /**
...
type PaymentAmountProperty2CurrencyEnum = 'GBP'
