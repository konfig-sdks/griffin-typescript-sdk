 ...
 * 
 * @export
 * @interface PaymentsListAdmissionsResponse
 */
export interface PaymentsListAdmissionsResponse {
    /**
     * 
     * @type {Array<Admission1>}
     * @memberof PaymentsListAdmissionsResponse
     */
    'admissions': Array<Admission1>;
}
