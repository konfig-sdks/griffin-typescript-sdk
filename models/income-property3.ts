 ...
 * 
 * @export
 * @interface IncomeProperty3
 */
export interface IncomeProperty3 {
    /**
     * 
     * @type {string}
     * @memberof IncomeProperty3
     */
    'currency': IncomeProperty3CurrencyEnum;
    /**
...
type IncomeProperty3CurrencyEnum = 'GBP'
