 ...
 * @export
 * @interface AvailableBalanceProperty1
 */
export interface AvailableBalanceProperty1 {
    /**
     * 
     * @type {string}
     * @memberof AvailableBalanceProperty1
     */
    'currency': AvailableBalanceProperty1CurrencyEnum;
    /**
...
type AvailableBalanceProperty1CurrencyEnum = 'GBP'
