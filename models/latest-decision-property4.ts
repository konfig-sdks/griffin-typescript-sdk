 ...
 * @export
 * @interface LatestDecisionProperty4
 */
export interface LatestDecisionProperty4 {
    /**
     * A link to the [verification](http://docs.griffin.com).
     * @type {string}
     * @memberof LatestDecisionProperty4
     */
     ...
     * @memberof LatestDecisionProperty4
     */
    'decision-outcome': LatestDecisionProperty4DecisionOutcomeEnum;
    /**
     * Indicates if the decision was automated or made by a human.
     * @type {string}
     * @memberof LatestDecisionProperty4
     */
    'decision-maker': LatestDecisionProperty4DecisionMakerEnum;
    /**
     ...
     * @memberof LatestDecisionProperty4
     */
    'decision-ops-user'?: LatestDecisionProperty4DecisionOpsUserEnum;
}

type LatestDecisionProperty4DecisionOutcomeEnum = 'accepted' | 'declined'
type LatestDecisionProperty4DecisionMakerEnum = 'system' | 'ops-user' | 'user'
type LatestDecisionProperty4DecisionOpsUserEnum = 'griffin-ops-user'
