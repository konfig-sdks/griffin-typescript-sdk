...
export interface BankAddress {
     ...
     * @memberof BankAddress
     */
    'bank-id-code': BankAddressBankIdCodeEnum;
    /**
     ...
     * @memberof BankAddress
     */
    'account-number-code': BankAddressAccountNumberCodeEnum;
}

type BankAddressBankIdCodeEnum = 'gbdsc'
type BankAddressAccountNumberCodeEnum = 'bban'
