 ...
 * @interface Fps1
 */
export interface Fps1 {
    /**
     * Unique and unambiguous identifier for a payment as assigned by the originator.
     * @type {string}
     * @memberof Fps1
     */
    'end-to-end-identification': string;
    /**
     * A scheme-specific code describing the current status.
     * @type {string}
     * @memberof Fps1
     */
    'scheme-status-code'?: string;
    /**
     * A human-readable description of the scheme status code.
     * @type {string}
     * @memberof Fps1
     */
     ...
     * @memberof Fps1
     */
    'payment-scheme': Fps1PaymentSchemeEnum;
}

type Fps1PaymentSchemeEnum = 'fps'
