...
export interface DecisionCreated {
     ...
     * 
     * @type {string}
     * @memberof DecisionCreated
     */
    'decision-outcome': DecisionCreatedDecisionOutcomeEnum;
    /**
     ...
     * @memberof DecisionCreated
     */
    'legal-person-history-event-type': DecisionCreatedLegalPersonHistoryEventTypeEnum;
    /**
     ...
     * @memberof DecisionCreated
     */
    'decision-maker': DecisionCreatedDecisionMakerEnum;
    /**
     ...
     * @memberof DecisionCreated
     */
    'decision-ops-user'?: DecisionCreatedDecisionOpsUserEnum;
    /**
...
type DecisionCreatedDecisionOutcomeEnum = 'accepted' | 'declined'
type DecisionCreatedLegalPersonHistoryEventTypeEnum = 'risk-rating-registered' | 'decision-created'
type DecisionCreatedDecisionMakerEnum = 'system' | 'ops-user' | 'user'
type DecisionCreatedDecisionOpsUserEnum = 'griffin-ops-user'
