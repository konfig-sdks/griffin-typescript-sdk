 ...
 * 
 * @export
 * @interface GriffinBankAccount3
 */
export interface GriffinBankAccount3 {
    /**
     * Link to the bank account resource.
     * @type {string}
     * @memberof GriffinBankAccount3
     */
    'account-url': string;
    /**
     * 
     ...
     * @memberof GriffinBankAccount3
     */
    'creditor-type': GriffinBankAccount3CreditorTypeEnum;
}

type GriffinBankAccount3CreditorTypeEnum = 'griffin-bank-account'
