 ...
 * @export
 * @interface LatestDecisionProperty2
 */
export interface LatestDecisionProperty2 {
    /**
     * A link to the [verification](http://docs.griffin.com).
     * @type {string}
     * @memberof LatestDecisionProperty2
     */
     ...
     * @memberof LatestDecisionProperty2
     */
    'decision-outcome': LatestDecisionProperty2DecisionOutcomeEnum;
    /**
     * Indicates if the decision was automated or made by a human.
     * @type {string}
     * @memberof LatestDecisionProperty2
     */
    'decision-maker': LatestDecisionProperty2DecisionMakerEnum;
    /**
     ...
     * @memberof LatestDecisionProperty2
     */
    'decision-ops-user'?: LatestDecisionProperty2DecisionOpsUserEnum;
}

type LatestDecisionProperty2DecisionOutcomeEnum = 'accepted' | 'declined'
type LatestDecisionProperty2DecisionMakerEnum = 'system' | 'ops-user' | 'user'
type LatestDecisionProperty2DecisionOpsUserEnum = 'griffin-ops-user'
