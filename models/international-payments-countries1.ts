 ...
 * 
 * @export
 * @interface InternationalPaymentsCountries1
 */
export interface InternationalPaymentsCountries1 {
    /**
     * 
     * @type {Array<any>}
     * @memberof InternationalPaymentsCountries1
     */
    'international-payments-countries': Array<any>;
    /**
     * 
     * @type {string}
     * @memberof InternationalPaymentsCountries1
     */
    'claim-type': InternationalPaymentsCountries1ClaimTypeEnum;
}

type InternationalPaymentsCountries1ClaimTypeEnum = 'international-payments-countries'
