 ...
 * 
 * @export
 * @interface IndividualPurposesOfAccount
 */
export interface IndividualPurposesOfAccount {
    /**
     * 
     * @type {Set<string>}
     * @memberof IndividualPurposesOfAccount
     */
    'individual-purposes-of-account': Set<IndividualPurposesOfAccountIndividualPurposesOfAccountEnum>;
    /**
     * 
     * @type {string}
     * @memberof IndividualPurposesOfAccount
     */
    'claim-type': IndividualPurposesOfAccountClaimTypeEnum;
}

type IndividualPurposesOfAccountIndividualPurposesOfAccountEnum = 'savings' | 'bills-and-repayment' | 'everyday-spending'
type IndividualPurposesOfAccountClaimTypeEnum = 'individual-purposes-of-account'
