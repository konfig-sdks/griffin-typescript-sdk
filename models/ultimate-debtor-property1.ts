 ...
 * 
 * @export
 * @interface UltimateDebtorProperty1
 */
export interface UltimateDebtorProperty1 {
    /**
     * Must be a UK BBAN.
     * @type {string}
     * @memberof UltimateDebtorProperty1
     */
     ...
     * @memberof UltimateDebtorProperty1
     */
    'account-number-code': UltimateDebtorProperty1AccountNumberCodeEnum;
    /**
     ...
     * @memberof UltimateDebtorProperty1
     */
    'bank-id-code': UltimateDebtorProperty1BankIdCodeEnum;
    /**
...
type UltimateDebtorProperty1AccountNumberCodeEnum = 'bban'
type UltimateDebtorProperty1BankIdCodeEnum = 'gbdsc'
