 ...
 * 
 * @export
 * @interface IndividualIncome5
 */
export interface IndividualIncome5 {
    /**
     * 
     * @type {Income1}
     * @memberof IndividualIncome5
     */
    'income': Income1;
    /**
     * 
     ...
     * @memberof IndividualIncome5
     */
    'claim-type': IndividualIncome5ClaimTypeEnum;
}

type IndividualIncome5ClaimTypeEnum = 'individual-income'
