 ...
 * 
 * @export
 * @interface InitialDeposit3
 */
export interface InitialDeposit3 {
    /**
     * 
     * @type {InitialDepositProperty2}
     * @memberof InitialDeposit3
     */
    'initial-deposit': InitialDepositProperty2;
    /**
     * 
     * @type {string}
     * @memberof InitialDeposit3
     */
    'claim-type': InitialDeposit3ClaimTypeEnum;
}

type InitialDeposit3ClaimTypeEnum = 'initial-deposit'
