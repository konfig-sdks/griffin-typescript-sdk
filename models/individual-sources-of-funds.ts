 ...
 * 
 * @export
 * @interface IndividualSourcesOfFunds
 */
export interface IndividualSourcesOfFunds {
    /**
     * 
     * @type {Set<string>}
     * @memberof IndividualSourcesOfFunds
     */
    'individual-sources-of-funds': Set<IndividualSourcesOfFundsIndividualSourcesOfFundsEnum>;
    /**
     * 
     * @type {string}
     * @memberof IndividualSourcesOfFunds
     */
    'claim-type': IndividualSourcesOfFundsClaimTypeEnum;
}

type IndividualSourcesOfFundsIndividualSourcesOfFundsEnum = 'gambling-or-lottery' | 'investments' | 'property-or-asset-sale' | 'savings' | 'salary-or-bonus' | 'student-loans-or-bursary' | 'retirement-or-pension' | 'legal-settlement' | 'family-or-gifted' | 'loan' | 'inheritance'
type IndividualSourcesOfFundsClaimTypeEnum = 'individual-sources-of-funds'
