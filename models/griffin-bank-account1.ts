 ...
 * 
 * @export
 * @interface GriffinBankAccount1
 */
export interface GriffinBankAccount1 {
    /**
     * Link to the bank account resource.
     * @type {string}
     * @memberof GriffinBankAccount1
     */
    'account-url': string;
    /**
     * 
     ...
     * @memberof GriffinBankAccount1
     */
    'creditor-type': GriffinBankAccount1CreditorTypeEnum;
}

type GriffinBankAccount1CreditorTypeEnum = 'griffin-bank-account'
