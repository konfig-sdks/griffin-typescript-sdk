...
import { AccountBalanceProperty6 } from './account-balance-property6';
import { AvailableBalanceProperty4 } from './available-balance-property4';
import { BankAddress4 } from './bank-address4';

/**
 * 
 * @export
 * @interface BankAccountsCreateNewAccountResponse
 */
export interface BankAccountsCreateNewAccountResponse {
    /**
     * Link to the [payment submissions](http://docs.griffin.com) debiting from this account.
     * @type {string}
     * @memberof BankAccountsCreateNewAccountResponse
     */
     ...
     * @memberof BankAccountsCreateNewAccountResponse
     */
    'bank-product-type': BankAccountsCreateNewAccountResponseBankProductTypeEnum;
    /**
     ...
     * @memberof BankAccountsCreateNewAccountResponse
     */
    'account-status': BankAccountsCreateNewAccountResponseAccountStatusEnum;
    /**
     * Specifies the type of client money account.
     * @type {string}
     * @memberof BankAccountsCreateNewAccountResponse
     */
    'client-money-type'?: BankAccountsCreateNewAccountResponseClientMoneyTypeEnum;
    /**
    ...
    /**
     * 
     * @type {AvailableBalanceProperty4}
     * @memberof BankAccountsCreateNewAccountResponse
     */
    'available-balance': AvailableBalanceProperty4;
    /**
     ...
     * @type {Array<BankAddress4>}
     * @memberof BankAccountsCreateNewAccountResponse
     */
    'bank-addresses'?: Array<BankAddress4>;
    /**
    ...
    /**
     * 
     * @type {AccountBalanceProperty6}
     * @memberof BankAccountsCreateNewAccountResponse
     */
    'account-balance': AccountBalanceProperty6;
    /**
     * Specifies the type of savings account.
     * @type {string}
     * @memberof BankAccountsCreateNewAccountResponse
     */
    'savings-type'?: BankAccountsCreateNewAccountResponseSavingsTypeEnum;
}

type BankAccountsCreateNewAccountResponseBankProductTypeEnum = 'savings-account' | 'client-money-account' | 'safeguarding-account' | 'operational-account'
type BankAccountsCreateNewAccountResponseAccountStatusEnum = 'closing' | 'open' | 'closed' | 'opening'
type BankAccountsCreateNewAccountResponseClientMoneyTypeEnum = 'designated-client-fund' | 'designated-client-money' | 'general-client-money'
type BankAccountsCreateNewAccountResponseSavingsTypeEnum = 'easy-access'
