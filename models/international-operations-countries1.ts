 ...
 * 
 * @export
 * @interface InternationalOperationsCountries1
 */
export interface InternationalOperationsCountries1 {
    /**
     * 
     * @type {Array<any>}
     * @memberof InternationalOperationsCountries1
     */
    'international-operations-countries': Array<any>;
    /**
     * 
     * @type {string}
     * @memberof InternationalOperationsCountries1
     */
    'claim-type': InternationalOperationsCountries1ClaimTypeEnum;
}

type InternationalOperationsCountries1ClaimTypeEnum = 'international-operations-countries'
