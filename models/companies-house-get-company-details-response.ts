...
import { CompanyAddressProperty } from './company-address-property';
import { Director4 } from './director4';
import { PersonWithSignificantControl4 } from './person-with-significant-control4';

/**
 * 
 * @export
 * @interface CompaniesHouseGetCompanyDetailsResponse
 */
export interface CompaniesHouseGetCompanyDetailsResponse {
    /**
     * 
     * @type {CompanyAddressProperty}
     * @memberof CompaniesHouseGetCompanyDetailsResponse
     */
    'company-address'?: CompanyAddressProperty;
    /**
     * ISO 8601 formatted date.
     * @type {string}
     * @memberof CompaniesHouseGetCompanyDetailsResponse
     */
    'date-of-latest-accounts'?: string;
    /**
     * 
     * @type {string}
     * @memberof CompaniesHouseGetCompanyDetailsResponse
    ...
    /**
     * 
     * @type {Array<Director4>}
     * @memberof CompaniesHouseGetCompanyDetailsResponse
     */
    'directors': Array<Director4>;
    /**
     * ISO 8601 formatted date.
     * @type {string}
     * @memberof CompaniesHouseGetCompanyDetailsResponse
     */
    'date-of-latest-confirmation-statement'?: string;
    /**
     * 
     * @type {string}
     * @memberof CompaniesHouseGetCompanyDetailsResponse
     */
    'corporation-type': CompaniesHouseGetCompanyDetailsResponseCorporationTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof CompaniesHouseGetCompanyDetailsResponse
     */
    'company-status': CompaniesHouseGetCompanyDetailsResponseCompanyStatusEnum;
    /**
     * 
     * @type {boolean}
     * @memberof CompaniesHouseGetCompanyDetailsResponse
     ...
     * @memberof CompaniesHouseGetCompanyDetailsResponse
     */
    'sic-codes'?: Array<string>;
    /**
     * 
     * @type {Array<PersonWithSignificantControl4>}
     * @memberof CompaniesHouseGetCompanyDetailsResponse
     */
    'persons-with-significant-control': Array<PersonWithSignificantControl4>;
    /**
     * 
     * @type {boolean}
     * @memberof CompaniesHouseGetCompanyDetailsResponse
