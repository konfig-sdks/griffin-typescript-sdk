 ...
 * 
 * @export
 * @interface PurposesOfAccount
 */
export interface PurposesOfAccount {
    /**
     * 
     * @type {Set<string>}
     * @memberof PurposesOfAccount
     */
    'purposes-of-account': Set<PurposesOfAccountPurposesOfAccountEnum>;
    /**
     * 
     * @type {string}
     * @memberof PurposesOfAccount
     */
    'claim-type': PurposesOfAccountClaimTypeEnum;
}

type PurposesOfAccountPurposesOfAccountEnum = 'short-term-investment' | 'long-term-investment' | 'safeguarding' | 'staff-payroll' | 'client-money' | 'business-expenses' | 'receiving-payments' | 'operational-spend'
type PurposesOfAccountClaimTypeEnum = 'purposes-of-account'
