 ...
 * 
 * @export
 * @interface AnnualTurnoverProperty
 */
export interface AnnualTurnoverProperty {
    /**
     * 
     * @type {string}
     * @memberof AnnualTurnoverProperty
     */
    'currency': AnnualTurnoverPropertyCurrencyEnum;
    /**
...
type AnnualTurnoverPropertyCurrencyEnum = 'GBP'
