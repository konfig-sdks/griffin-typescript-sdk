 ...
 * 
 * @export
 * @interface PaymentsGetSubmissionResponse
 */
export interface PaymentsGetSubmissionResponse {
    /**
     * Specifies the progress of the outbound payment.
     * @type {string}
     * @memberof PaymentsGetSubmissionResponse
     */
    'submission-status': PaymentsGetSubmissionResponseSubmissionStatusEnum;
    /**
     * 
...
type PaymentsGetSubmissionResponseSubmissionStatusEnum = 'failed' | 'processing' | 'returned' | 'delivered'
