 ...
 * 
 * @export
 * @interface SourcesOfFunds1
 */
export interface SourcesOfFunds1 {
    /**
     * 
     * @type {Set<string>}
     * @memberof SourcesOfFunds1
     */
    'sources-of-funds': Set<SourcesOfFunds1SourcesOfFundsEnum>;
    /**
     * 
     * @type {string}
     * @memberof SourcesOfFunds1
     */
    'claim-type': SourcesOfFunds1ClaimTypeEnum;
}

type SourcesOfFunds1SourcesOfFundsEnum = 'gambling-or-lottery' | 'investments' | 'property-or-asset-sale' | 'business-income' | 'savings' | 'salary-or-bonus' | 'student-loans-or-bursary' | 'retirement-or-pension' | 'legal-settlement' | 'family-or-gifted' | 'loan' | 'inheritance'
type SourcesOfFunds1ClaimTypeEnum = 'sources-of-funds'
