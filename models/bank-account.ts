...
import { AccountBalanceProperty5 } from './account-balance-property5';
import { AvailableBalanceProperty3 } from './available-balance-property3';
import { BankAddress3 } from './bank-address3';
...
export interface BankAccount {
     ...
     * @memberof BankAccount
     */
    'bank-product-type': BankAccountBankProductTypeEnum;
    /**
     ...
     * @memberof BankAccount
     */
    'account-status': BankAccountAccountStatusEnum;
    /**
     * Specifies the type of client money account.
     * @type {string}
     * @memberof BankAccount
     */
    'client-money-type'?: BankAccountClientMoneyTypeEnum;
    /**
    ...
    /**
     * 
     * @type {AvailableBalanceProperty3}
     * @memberof BankAccount
     */
    'available-balance': AvailableBalanceProperty3;
    /**
     ...
     * @type {Array<BankAddress3>}
     * @memberof BankAccount
     */
    'bank-addresses'?: Array<BankAddress3>;
    /**
    ...
    /**
     * 
     * @type {AccountBalanceProperty5}
     * @memberof BankAccount
     */
    'account-balance': AccountBalanceProperty5;
    /**
     * Specifies the type of savings account.
     * @type {string}
     * @memberof BankAccount
     */
    'savings-type'?: BankAccountSavingsTypeEnum;
}

type BankAccountBankProductTypeEnum = 'savings-account' | 'client-money-account' | 'safeguarding-account' | 'operational-account'
type BankAccountAccountStatusEnum = 'closing' | 'open' | 'closed' | 'opening'
type BankAccountClientMoneyTypeEnum = 'designated-client-fund' | 'designated-client-money' | 'general-client-money'
type BankAccountSavingsTypeEnum = 'easy-access'
