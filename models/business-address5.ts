 ...
 * 
 * @export
 * @interface BusinessAddress5
 */
export interface BusinessAddress5 {
    /**
     * 
     * @type {object}
     * @memberof BusinessAddress5
     */
     ...
     * @memberof BusinessAddress5
     */
    'claim-type': BusinessAddress5ClaimTypeEnum;
}

type BusinessAddress5ClaimTypeEnum = 'business-address'
