 ...
 * 
 * @export
 * @interface IncomeProperty1
 */
export interface IncomeProperty1 {
    /**
     * 
     * @type {string}
     * @memberof IncomeProperty1
     */
    'currency': IncomeProperty1CurrencyEnum;
    /**
...
type IncomeProperty1CurrencyEnum = 'GBP'
