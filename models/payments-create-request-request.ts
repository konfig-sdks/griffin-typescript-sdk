...
import { CreditorProperty } from './creditor-property';
import { PaymentAmountProperty } from './payment-amount-property';

/**
 * 
 * @export
 * @interface PaymentsCreateRequestRequest
 */
export interface PaymentsCreateRequestRequest {
    /**
     * 
     * @type {CreditorProperty}
     * @memberof PaymentsCreateRequestRequest
     */
    'creditor': CreditorProperty;
    /**
     * 
     * @type {PaymentAmountProperty}
     * @memberof PaymentsCreateRequestRequest
     */
    'payment-amount': PaymentAmountProperty;
    /**
