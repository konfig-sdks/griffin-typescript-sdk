 ...
 * 
 * @export
 * @interface EventsGetAllOrganizationEventsResponse
 */
export interface EventsGetAllOrganizationEventsResponse {
    /**
     * 
     * @type {Array<Event>}
     * @memberof EventsGetAllOrganizationEventsResponse
     */
    'events': Array<Event>;
    /**
     * 
