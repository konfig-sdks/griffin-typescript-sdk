 ...
 * @export
 * @interface AccountBalanceProperty4
 */
export interface AccountBalanceProperty4 {
    /**
     * 
     * @type {string}
     * @memberof AccountBalanceProperty4
     */
    'currency': AccountBalanceProperty4CurrencyEnum;
    /**
...
type AccountBalanceProperty4CurrencyEnum = 'GBP'
