 ...
 * 
 * @export
 * @interface InitialDeposit1
 */
export interface InitialDeposit1 {
    /**
     * 
     * @type {InitialDepositProperty}
     * @memberof InitialDeposit1
     */
    'initial-deposit': InitialDepositProperty;
    /**
     * 
     * @type {string}
     * @memberof InitialDeposit1
     */
    'claim-type': InitialDeposit1ClaimTypeEnum;
}

type InitialDeposit1ClaimTypeEnum = 'initial-deposit'
