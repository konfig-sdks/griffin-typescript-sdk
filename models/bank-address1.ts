 ...
 * 
 * @export
 * @interface BankAddress1
 */
export interface BankAddress1 {
    /**
     * The name of the [account holder](http://docs.griffin.com).
     * @type {string}
     * @memberof BankAddress1
     */
     ...
     * @memberof BankAddress1
     */
    'bank-id-code': BankAddress1BankIdCodeEnum;
    /**
     ...
     * @memberof BankAddress1
     */
    'account-number-code': BankAddress1AccountNumberCodeEnum;
}

type BankAddress1BankIdCodeEnum = 'gbdsc'
type BankAddress1AccountNumberCodeEnum = 'bban'
