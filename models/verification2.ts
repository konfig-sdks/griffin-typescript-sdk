...
export interface Verification2 {
     ...
     * @memberof Verification2
     */
    'risk-rating'?: Verification2RiskRatingEnum;
    /**
     * 
     * @type {string}
     * @memberof Verification2
     */
    'verification-status': Verification2VerificationStatusEnum;
    /**
     * 
     * @type {string}
     * @memberof Verification2
...
type Verification2RiskRatingEnum = 'high-risk' | 'prohibited-risk' | 'medium-risk' | 'low-risk'
type Verification2VerificationStatusEnum = 'in-progress' | 'pending' | 'checks-declined' | 'checks-complete' | 'failed'
