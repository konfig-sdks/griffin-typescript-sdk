 ...
 * 
 * @export
 * @interface VerificationsInitiateVerificationResponse
 */
export interface VerificationsInitiateVerificationResponse {
    /**
     * A link to the [verification](http://docs.griffin.com).
     * @type {string}
     * @memberof VerificationsInitiateVerificationResponse
     */
     ...
     * @memberof VerificationsInitiateVerificationResponse
     */
    'risk-rating'?: VerificationsInitiateVerificationResponseRiskRatingEnum;
    /**
     * 
     * @type {string}
     * @memberof VerificationsInitiateVerificationResponse
     */
    'verification-status': VerificationsInitiateVerificationResponseVerificationStatusEnum;
    /**
     * 
     * @type {string}
     * @memberof VerificationsInitiateVerificationResponse
...
type VerificationsInitiateVerificationResponseRiskRatingEnum = 'high-risk' | 'prohibited-risk' | 'medium-risk' | 'low-risk'
type VerificationsInitiateVerificationResponseVerificationStatusEnum = 'in-progress' | 'pending' | 'checks-declined' | 'checks-complete' | 'failed'
