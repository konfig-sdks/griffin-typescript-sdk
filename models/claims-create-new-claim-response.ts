...
import { AlternativeNumber } from './alternative-number';
import { AnnualTurnover5 } from './annual-turnover5';
import { BusinessAddress5 } from './business-address5';
import { BusinessDescription } from './business-description';
import { BusinessName } from './business-name';
import { CompanyEmailAddress } from './company-email-address';
import { CompanyTelephoneNumber } from './company-telephone-number';
import { CompanyWebsite } from './company-website';
import { ContactDetails } from './contact-details';
import { Director6 } from './director6';
import { Employment } from './employment';
import { Income1 } from './income1';
import { IndividualIdentity } from './individual-identity';
import { IndividualIncome5 } from './individual-income5';
import { IndividualPurposesOfAccount } from './individual-purposes-of-account';
import { IndividualResidence5 } from './individual-residence5';
import { IndividualSourcesOfFunds } from './individual-sources-of-funds';
import { InitialDeposit5 } from './initial-deposit5';
import { InternationalOperationsCountries } from './international-operations-countries';
import { InternationalPaymentsCountries } from './international-payments-countries';
import { MobileNumber } from './mobile-number';
import { Nationality } from './nationality';
import { NominalPersonWithSignificantControl5 } from './nominal-person-with-significant-control5';
import { PersonWithSignificantControl6 } from './person-with-significant-control6';
import { PurposesOfAccount } from './purposes-of-account';
import { RelianceVerification } from './reliance-verification';
import { SicCodes5 } from './sic-codes5';
import { SocialMedia } from './social-media';
import { SoleTrader5 } from './sole-trader5';
import { SourcesOfFunds } from './sources-of-funds';
import { TaxIdentificationNumber } from './tax-identification-number';
import { TaxResidency } from './tax-residency';
import { TradingAddress5 } from './trading-address5';
import { TradingName } from './trading-name';
import { UkCompanyRegister5 } from './uk-company-register5';
import { UkFinancialServicesRegister } from './uk-financial-services-register';

/**
 * @type ClaimsCreateNewClaimResponse
 * @export
 */
export type ClaimsCreateNewClaimResponse = MobileNumber | IndividualIdentity | SoleTrader5 | UkCompanyRegister5 | IndividualIncome5 | InitialDeposit5 | InternationalPaymentsCountries | CompanyTelephoneNumber | PersonWithSignificantControl6 | CompanyEmailAddress | TaxResidency | UkFinancialServicesRegister | BusinessDescription | IndividualSourcesOfFunds | NominalPersonWithSignificantControl5 | BusinessAddress5 | Employment | AnnualTurnover5 | PurposesOfAccount | SicCodes5 | InternationalOperationsCountries | SourcesOfFunds | ContactDetails | RelianceVerification | BusinessName | IndividualPurposesOfAccount | Nationality | TradingName | SocialMedia | TradingAddress5 | CompanyWebsite | Director6 | AlternativeNumber | TaxIdentificationNumber | IndividualResidence5;
