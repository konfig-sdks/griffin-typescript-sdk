 ...
 * 
 * @export
 * @interface TransactionsListBalanceChangesResponse
 */
export interface TransactionsListBalanceChangesResponse {
    /**
     * 
     * @type {Array<AccountTransaction>}
     * @memberof TransactionsListBalanceChangesResponse
     */
    'account-transactions': Array<AccountTransaction>;
    /**
     * 
     * @type {LinksProperty}
     * @memberof TransactionsListBalanceChangesResponse
