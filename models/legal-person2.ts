...
import { LatestDecisionProperty4 } from './latest-decision-property4';

/**
 * 
 * @export
 * @interface LegalPerson2
 */
export interface LegalPerson2 {
    /**
     * 
     * @type {LatestDecisionProperty4}
     * @memberof LegalPerson2
     */
    'latest-decision'?: LatestDecisionProperty4;
    /**
     * Specifies if the legal person is an `individual` or a `corporation`.
     * @type {string}
     * @memberof LegalPerson2
     */
    'legal-person-type': LegalPerson2LegalPersonTypeEnum;
    /**
     ...
     * @memberof LegalPerson2
     */
    'application-status'?: LegalPerson2ApplicationStatusEnum;
    /**
...
type LegalPerson2LegalPersonTypeEnum = 'individual' | 'corporation'
type LegalPerson2ApplicationStatusEnum = 'referred' | 'errored' | 'declined' | 'submitted' | 'accepted'
