 ...
 * 
 * @export
 * @interface EstimatedTotalProperty
 */
export interface EstimatedTotalProperty {
    /**
     * Present when the total number of items in the full result set exceeds 10,000. This indicates that the actual number of items is at least 10,000, but the exact total is not provided due to performance considerations.
     * @type {string}
     * @memberof EstimatedTotalProperty
     */
    'at-least'?: EstimatedTotalPropertyAtLeastEnum;
}

type EstimatedTotalPropertyAtLeastEnum = '10000'
