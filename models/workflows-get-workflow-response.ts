 ...
 * 
 * @export
 * @interface WorkflowsGetWorkflowResponse
 */
export interface WorkflowsGetWorkflowResponse {
    /**
     * A link to the [workflow](http://docs.griffin.com).
     * @type {string}
     * @memberof WorkflowsGetWorkflowResponse
     */
    'workflow-url': string;
    /**
     ...
     * @memberof WorkflowsGetWorkflowResponse
     */
    'legal-person-type': WorkflowsGetWorkflowResponseLegalPersonTypeEnum;
    /**
     ...
     * @memberof WorkflowsGetWorkflowResponse
     */
    'required-claim-types'?: { [key: string]: Set<string>; };
    /**
     * A list of special behaviours a workflow can possess.
     * @type {Set<string>}
     * @memberof WorkflowsGetWorkflowResponse
     */
    'workflow-rules'?: Set<WorkflowsGetWorkflowResponseWorkflowRulesEnum>;
}

type WorkflowsGetWorkflowResponseLegalPersonTypeEnum = 'individual' | 'corporation'
type WorkflowsGetWorkflowResponseRequiredClaimTypesEnum = 'mobile-number' | 'individual-identity' | 'sole-trader' | 'uk-company-register' | 'individual-income' | 'business-website' | 'initial-deposit' | 'international-payments-countries' | 'company-telephone-number' | 'managed-properties' | 'person-with-significant-control' | 'tenant-cash-payments' | 'verified-bank-account' | 'company-email-address' | 'tax-residency' | 'uk-financial-services-register' | 'non-tenant-balance' | 'business-description' | 'hmrc-register' | 'business-email-address' | 'client-money-protection-scheme' | 'individual-sources-of-funds' | 'nominal-person-with-significant-control' | 'hmo-verification' | 'business-address' | 'employment' | 'annual-turnover' | 'purposes-of-account' | 'sic-codes' | 'international-operations-countries' | 'sources-of-funds' | 'business-owner' | 'business-telephone-number' | 'individual-email-address' | 'business-start-date' | 'contact-details' | 'reliance-verification' | 'ultimate-beneficial-owner' | 'business-name' | 'individual-purposes-of-account' | 'nationality' | 'trading-name' | 'number-of-employees' | 'social-media' | 'trading-address' | 'company-website' | 'director' | 'alternative-number' | 'tax-identification-number' | 'individual-residence'
type WorkflowsGetWorkflowResponseWorkflowRulesEnum = 'allow-zero-directors' | 'allow-missing-directors'
