 ...
 * 
 * @export
 * @interface TradingAddress2
 */
export interface TradingAddress2 {
    /**
     * 
     * @type {TradingAddressProperty3}
     * @memberof TradingAddress2
     */
    'trading-address': TradingAddressProperty3;
    /**
     * 
     * @type {string}
     * @memberof TradingAddress2
     */
    'claim-type': TradingAddress2ClaimTypeEnum;
}

type TradingAddress2ClaimTypeEnum = 'trading-address'
