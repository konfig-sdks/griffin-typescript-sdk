 ...
 * 
 * @export
 * @interface PooledAccountMembershipManageLegalPersonsRequest
 */
export interface PooledAccountMembershipManageLegalPersonsRequest {
    /**
     * 
     * @type {Array<string>}
     * @memberof PooledAccountMembershipManageLegalPersonsRequest
     */
