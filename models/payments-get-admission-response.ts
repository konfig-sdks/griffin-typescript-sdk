...
import { AdmissionSchemeInformationProperty } from './admission-scheme-information-property';

/**
 * 
 * @export
 * @interface PaymentsGetAdmissionResponse
 */
export interface PaymentsGetAdmissionResponse {
    /**
     * Specifies the progress of the inbound payment.
     * @type {string}
     * @memberof PaymentsGetAdmissionResponse
     */
    'admission-status': PaymentsGetAdmissionResponseAdmissionStatusEnum;
    /**
     * 
     * @type {AdmissionSchemeInformationProperty}
     * @memberof PaymentsGetAdmissionResponse
     */
    'admission-scheme-information': AdmissionSchemeInformationProperty;
    /**
     ...
     * @memberof PaymentsGetAdmissionResponse
     */
    'admission-url': string;
}

type PaymentsGetAdmissionResponseAdmissionStatusEnum = 'processing' | 'returned' | 'delivered'
