 ...
 * 
 * @export
 * @interface EventsGetEventResponse
 */
export interface EventsGetEventResponse {
    /**
     * Link to the [event](http://docs.griffin.com).
     * @type {string}
     * @memberof EventsGetEventResponse
     */
    'event-url': string;
    /**
     ...
     * @memberof EventsGetEventResponse
     */
    'event-type': EventsGetEventResponseEventTypeEnum;
    /**
     * 
     * @type {object}
     * @memberof EventsGetEventResponse
...
type EventsGetEventResponseEventTypeEnum = 'decision-created' | 'payment-created' | 'transaction-created' | 'verification-updated' | 'admission-updated' | 'verification-created' | 'account-status-updated' | 'submission-created' | 'test-event' | 'admission-created' | 'account-status-created' | 'submission-updated'
