 ...
 * @interface Complete1
 */
export interface Complete1 {
    /**
     * 
     * @type {string}
     * @memberof Complete1
     */
    'webhook-request-status': Complete1WebhookRequestStatusEnum;
    /**
     ...
     * @memberof Complete1
     */
    'webhook-http-status': number;
    /**
     * 
     * @type {string}
     * @memberof Complete1
     */
    'webhook-error-code': Complete1WebhookErrorCodeEnum;
}

type Complete1WebhookRequestStatusEnum = 'complete'
type Complete1WebhookErrorCodeEnum = 'webhook-timeout' | 'webhook-unknown-host' | 'webhook-unknown-error' | 'webhook-invalid-response'
