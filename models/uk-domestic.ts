 ...
 * 
 * @export
 * @interface UkDomestic
 */
export interface UkDomestic {
    /**
     ...
     * @memberof UkDomestic
     */
    'account-number-code': UkDomesticAccountNumberCodeEnum;
    /**
     ...
     * @memberof UkDomestic
     */
    'bank-id-code': UkDomesticBankIdCodeEnum;
    /**
     * 
     * @type {string}
     * @memberof UkDomestic
     */
    'creditor-type': UkDomesticCreditorTypeEnum;
}

type UkDomesticAccountNumberCodeEnum = 'bban'
type UkDomesticBankIdCodeEnum = 'gbdsc'
type UkDomesticCreditorTypeEnum = 'uk-domestic'
