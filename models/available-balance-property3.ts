 ...
 * @export
 * @interface AvailableBalanceProperty3
 */
export interface AvailableBalanceProperty3 {
    /**
     * 
     * @type {string}
     * @memberof AvailableBalanceProperty3
     */
    'currency': AvailableBalanceProperty3CurrencyEnum;
    /**
...
type AvailableBalanceProperty3CurrencyEnum = 'GBP'
