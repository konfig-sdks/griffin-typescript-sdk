 ...
 * 
 * @export
 * @interface BusinessAddress2
 */
export interface BusinessAddress2 {
    /**
     * 
     * @type {BusinessAddressProperty1}
     * @memberof BusinessAddress2
     */
    'business-address': BusinessAddressProperty1;
    /**
     * 
     * @type {string}
     * @memberof BusinessAddress2
     */
    'claim-type': BusinessAddress2ClaimTypeEnum;
}

type BusinessAddress2ClaimTypeEnum = 'business-address'
