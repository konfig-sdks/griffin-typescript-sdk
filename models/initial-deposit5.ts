 ...
 * 
 * @export
 * @interface InitialDeposit5
 */
export interface InitialDeposit5 {
    /**
     * 
     * @type {InitialDeposit5}
     * @memberof InitialDeposit5
     */
    'initial-deposit': InitialDeposit5;
    /**
     * 
     * @type {string}
     * @memberof InitialDeposit5
     */
    'claim-type': InitialDeposit5ClaimTypeEnum;
}

type InitialDeposit5ClaimTypeEnum = 'initial-deposit'
