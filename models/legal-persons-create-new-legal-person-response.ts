...
import { LatestDecisionProperty5 } from './latest-decision-property5';

/**
 * 
 * @export
 * @interface LegalPersonsCreateNewLegalPersonResponse
 */
export interface LegalPersonsCreateNewLegalPersonResponse {
    /**
     * 
     * @type {LatestDecisionProperty5}
     * @memberof LegalPersonsCreateNewLegalPersonResponse
     */
    'latest-decision'?: LatestDecisionProperty5;
    /**
     * Specifies if the legal person is an `individual` or a `corporation`.
     * @type {string}
     * @memberof LegalPersonsCreateNewLegalPersonResponse
     */
    'legal-person-type': LegalPersonsCreateNewLegalPersonResponseLegalPersonTypeEnum;
    /**
     * A contextual link to the risk rating.
     * @type {string}
     * @memberof LegalPersonsCreateNewLegalPersonResponse
     */
    'latest-risk-rating-url'?: string;
    /**
     ...
     * @memberof LegalPersonsCreateNewLegalPersonResponse
     */
    'application-status'?: LegalPersonsCreateNewLegalPersonResponseApplicationStatusEnum;
    /**
     ...
     * @memberof LegalPersonsCreateNewLegalPersonResponse
     */
    'legal-person-decisions-url': string;
    /**
     ...
     * @memberof LegalPersonsCreateNewLegalPersonResponse
     */
    'legal-person-verifications-url': string;
    /**
     * Link to all evidence documents associated with this [legal person](http://docs.griffin.com).
     * @type {string}
     * @memberof LegalPersonsCreateNewLegalPersonResponse
     */
    'legal-person-documents-url': string;
}

type LegalPersonsCreateNewLegalPersonResponseLegalPersonTypeEnum = 'individual' | 'corporation'
type LegalPersonsCreateNewLegalPersonResponseApplicationStatusEnum = 'referred' | 'errored' | 'declined' | 'submitted' | 'accepted'
