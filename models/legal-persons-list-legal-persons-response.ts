...
import { LegalPerson2 } from './legal-person2';
 ...
 * 
 * @export
 * @interface LegalPersonsListLegalPersonsResponse
 */
export interface LegalPersonsListLegalPersonsResponse {
    /**
     * 
     * @type {Array<LegalPerson2>}
     * @memberof LegalPersonsListLegalPersonsResponse
     */
    'legal-persons': Array<LegalPerson2>;
    /**
     * 
     * @type {LinksProperty}
     * @memberof LegalPersonsListLegalPersonsResponse
