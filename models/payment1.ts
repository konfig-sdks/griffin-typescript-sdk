...
import { CreditorProperty3 } from './creditor-property3';
import { DebtorProperty2 } from './debtor-property2';
import { PaymentAmountProperty3 } from './payment-amount-property3';
import { UltimateDebtorProperty2 } from './ultimate-debtor-property2';
...
export interface Payment1 {
    /**
     * 
     * @type {CreditorProperty3}
     * @memberof Payment1
     */
    'creditor': CreditorProperty3;
    /**
     * Whether the payment is moving money into or out of the account.
     * @type {string}
     * @memberof Payment1
     */
    'payment-direction': Payment1PaymentDirectionEnum;
    /**
    ...
    /**
     * 
     * @type {PaymentAmountProperty3}
     * @memberof Payment1
     */
    'payment-amount': PaymentAmountProperty3;
    /**
     * 
     * @type {UltimateDebtorProperty2}
     * @memberof Payment1
     */
    'ultimate-debtor'?: UltimateDebtorProperty2;
    /**
    ...
    /**
     * 
     * @type {DebtorProperty2}
     * @memberof Payment1
     */
    'debtor': DebtorProperty2;
}

type Payment1PaymentDirectionEnum = 'inbound-payment' | 'outbound-payment'
