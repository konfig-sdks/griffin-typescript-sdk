...
export interface Complete {
     ...
     * @memberof Complete
     */
    'decision-outcome': CompleteDecisionOutcomeEnum;
    /**
     * 
     * @type {string}
     * @memberof Complete
     */
    'onboarding-application-status': CompleteOnboardingApplicationStatusEnum;
}

type CompleteDecisionOutcomeEnum = 'accepted' | 'declined'
type CompleteOnboardingApplicationStatusEnum = 'complete'
