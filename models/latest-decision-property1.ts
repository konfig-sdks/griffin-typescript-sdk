 ...
 * @export
 * @interface LatestDecisionProperty1
 */
export interface LatestDecisionProperty1 {
    /**
     * A link to the [verification](http://docs.griffin.com).
     * @type {string}
     * @memberof LatestDecisionProperty1
     */
     ...
     * @memberof LatestDecisionProperty1
     */
    'decision-outcome': LatestDecisionProperty1DecisionOutcomeEnum;
    /**
     * Indicates if the decision was automated or made by a human.
     * @type {string}
     * @memberof LatestDecisionProperty1
     */
    'decision-maker': LatestDecisionProperty1DecisionMakerEnum;
    /**
     ...
     * @memberof LatestDecisionProperty1
     */
    'decision-ops-user'?: LatestDecisionProperty1DecisionOpsUserEnum;
}

type LatestDecisionProperty1DecisionOutcomeEnum = 'accepted' | 'declined'
type LatestDecisionProperty1DecisionMakerEnum = 'system' | 'ops-user' | 'user'
type LatestDecisionProperty1DecisionOpsUserEnum = 'griffin-ops-user'
