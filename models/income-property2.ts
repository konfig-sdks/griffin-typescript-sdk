 ...
 * 
 * @export
 * @interface IncomeProperty2
 */
export interface IncomeProperty2 {
    /**
     * 
     * @type {string}
     * @memberof IncomeProperty2
     */
    'currency': IncomeProperty2CurrencyEnum;
    /**
...
type IncomeProperty2CurrencyEnum = 'GBP'
