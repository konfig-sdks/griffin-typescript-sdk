 ...
 * @export
 * @interface AvailableBalanceProperty
 */
export interface AvailableBalanceProperty {
    /**
     * 
     * @type {string}
     * @memberof AvailableBalanceProperty
     */
    'currency': AvailableBalancePropertyCurrencyEnum;
    /**
...
type AvailableBalancePropertyCurrencyEnum = 'GBP'
