 ...
 * 
 * @export
 * @interface PersonWithSignificantControl3
 */
export interface PersonWithSignificantControl3 {
    /**
     * A contextual link to the [legal person](http://docs.griffin.com).
     * @type {string}
     * @memberof PersonWithSignificantControl3
     */
     ...
     * @memberof PersonWithSignificantControl3
     */
    'claim-type': PersonWithSignificantControl3ClaimTypeEnum;
}

type PersonWithSignificantControl3ClaimTypeEnum = 'person-with-significant-control'
