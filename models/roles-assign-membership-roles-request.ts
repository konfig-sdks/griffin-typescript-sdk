 ...
 * 
 * @export
 * @interface RolesAssignMembershipRolesRequest
 */
export interface RolesAssignMembershipRolesRequest {
    /**
     * 
     * @type {Array<string>}
     * @memberof RolesAssignMembershipRolesRequest
     */
    'role-urls': Array<string>;
}
