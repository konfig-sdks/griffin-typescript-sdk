 ...
 * 
 * @export
 * @interface PaymentsSubmitPaymentSubmissionRequest
 */
export interface PaymentsSubmitPaymentSubmissionRequest {
    /**
     * Specifies the scheme over which a payment is executed.
     * @type {string}
     * @memberof PaymentsSubmitPaymentSubmissionRequest
     */
    'payment-scheme'?: PaymentsSubmitPaymentSubmissionRequestPaymentSchemeEnum;
}

type PaymentsSubmitPaymentSubmissionRequestPaymentSchemeEnum = 'fps'
