...
import { LatestDecisionProperty } from './latest-decision-property';
...
export interface LegalPerson {
    /**
     * 
     * @type {LatestDecisionProperty}
     * @memberof LegalPerson
     */
    'latest-decision'?: LatestDecisionProperty;
    /**
     * Specifies if the legal person is an `individual` or a `corporation`.
     * @type {string}
     * @memberof LegalPerson
     */
    'legal-person-type': LegalPersonLegalPersonTypeEnum;
    /**
     ...
     * @memberof LegalPerson
     */
    'application-status'?: LegalPersonApplicationStatusEnum;
    /**
...
type LegalPersonLegalPersonTypeEnum = 'individual' | 'corporation'
type LegalPersonApplicationStatusEnum = 'referred' | 'errored' | 'declined' | 'submitted' | 'accepted'
