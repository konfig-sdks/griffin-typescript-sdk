 ...
 * @export
 * @interface AvailableBalanceProperty2
 */
export interface AvailableBalanceProperty2 {
    /**
     * 
     * @type {string}
     * @memberof AvailableBalanceProperty2
     */
    'currency': AvailableBalanceProperty2CurrencyEnum;
    /**
     * The value as a decimal-formatted string
     * @type {string}
     * @memberof AvailableBalanceProperty2
     */
    'value': string;
...
type AvailableBalanceProperty2CurrencyEnum = 'GBP'
