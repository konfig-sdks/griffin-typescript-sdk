 ...
 * @export
 * @interface PaymentAmountProperty4
 */
export interface PaymentAmountProperty4 {
    /**
     * 
     * @type {string}
     * @memberof PaymentAmountProperty4
     */
    'currency': PaymentAmountProperty4CurrencyEnum;
    /**
...
type PaymentAmountProperty4CurrencyEnum = 'GBP'
