 ...
 * @export
 * @interface PaymentAmountProperty3
 */
export interface PaymentAmountProperty3 {
    /**
     * 
     * @type {string}
     * @memberof PaymentAmountProperty3
     */
    'currency': PaymentAmountProperty3CurrencyEnum;
    /**
...
type PaymentAmountProperty3CurrencyEnum = 'GBP'
