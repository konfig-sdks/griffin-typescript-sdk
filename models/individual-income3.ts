 ...
 * 
 * @export
 * @interface IndividualIncome3
 */
export interface IndividualIncome3 {
    /**
     * 
     * @type {IncomeProperty2}
     * @memberof IndividualIncome3
     */
    'income': IncomeProperty2;
    /**
     * 
     * @type {string}
     * @memberof IndividualIncome3
     */
    'claim-type': IndividualIncome3ClaimTypeEnum;
}

type IndividualIncome3ClaimTypeEnum = 'individual-income'
