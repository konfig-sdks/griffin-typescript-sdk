 ...
 * 
 * @export
 * @interface InitialDeposit4
 */
export interface InitialDeposit4 {
    /**
     * 
     * @type {InitialDepositProperty3}
     * @memberof InitialDeposit4
     */
    'initial-deposit': InitialDepositProperty3;
    /**
     * 
     * @type {string}
     * @memberof InitialDeposit4
     */
    'claim-type': InitialDeposit4ClaimTypeEnum;
}

type InitialDeposit4ClaimTypeEnum = 'initial-deposit'
