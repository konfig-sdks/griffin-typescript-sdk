 ...
 * 
 * @export
 * @interface UkDomestic1
 */
export interface UkDomestic1 {
    /**
     * The name of the [account holder](http://docs.griffin.com).
     * @type {string}
     * @memberof UkDomestic1
     */
     ...
     * @memberof UkDomestic1
     */
    'account-number-code': UkDomestic1AccountNumberCodeEnum;
    /**
     ...
     * @memberof UkDomestic1
     */
    'bank-id-code': UkDomestic1BankIdCodeEnum;
    /**
     * 
     * @type {string}
     * @memberof UkDomestic1
     */
    'creditor-type': UkDomestic1CreditorTypeEnum;
}

type UkDomestic1AccountNumberCodeEnum = 'bban'
type UkDomestic1BankIdCodeEnum = 'gbdsc'
type UkDomestic1CreditorTypeEnum = 'uk-domestic'
