 ...
 * 
 * @export
 * @interface InitialDepositProperty3
 */
export interface InitialDepositProperty3 {
    /**
     * 
     * @type {string}
     * @memberof InitialDepositProperty3
     */
    'currency': InitialDepositProperty3CurrencyEnum;
    /**
...
type InitialDepositProperty3CurrencyEnum = 'GBP'
