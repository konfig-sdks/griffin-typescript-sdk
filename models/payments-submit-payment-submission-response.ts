...
import { SubmissionSchemeInformationProperty } from './submission-scheme-information-property';

/**
 * 
 * @export
 * @interface PaymentsSubmitPaymentSubmissionResponse
 */
export interface PaymentsSubmitPaymentSubmissionResponse {
    /**
     * Specifies the progress of the outbound payment.
     * @type {string}
     * @memberof PaymentsSubmitPaymentSubmissionResponse
     */
    'submission-status': PaymentsSubmitPaymentSubmissionResponseSubmissionStatusEnum;
    /**
     * 
     * @type {SubmissionSchemeInformationProperty}
     * @memberof PaymentsSubmitPaymentSubmissionResponse
     */
    'submission-scheme-information': SubmissionSchemeInformationProperty;
    /**
...
type PaymentsSubmitPaymentSubmissionResponseSubmissionStatusEnum = 'failed' | 'processing' | 'returned' | 'delivered'
