 ...
 * 
 * @export
 * @interface BusinessAddress3
 */
export interface BusinessAddress3 {
    /**
     * 
     * @type {BusinessAddressProperty2}
     * @memberof BusinessAddress3
     */
    'business-address': BusinessAddressProperty2;
    /**
     * 
     * @type {string}
     * @memberof BusinessAddress3
     */
    'claim-type': BusinessAddress3ClaimTypeEnum;
}

type BusinessAddress3ClaimTypeEnum = 'business-address'
