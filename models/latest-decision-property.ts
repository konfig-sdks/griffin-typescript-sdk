 ...
 * @export
 * @interface LatestDecisionProperty
 */
export interface LatestDecisionProperty {
    /**
     * A link to the [verification](http://docs.griffin.com).
     * @type {string}
     * @memberof LatestDecisionProperty
     */
     ...
     * @memberof LatestDecisionProperty
     */
    'decision-outcome': LatestDecisionPropertyDecisionOutcomeEnum;
    /**
     * Indicates if the decision was automated or made by a human.
     * @type {string}
     * @memberof LatestDecisionProperty
     */
    'decision-maker': LatestDecisionPropertyDecisionMakerEnum;
    /**
     ...
     * @memberof LatestDecisionProperty
     */
    'decision-ops-user'?: LatestDecisionPropertyDecisionOpsUserEnum;
}

type LatestDecisionPropertyDecisionOutcomeEnum = 'accepted' | 'declined'
type LatestDecisionPropertyDecisionMakerEnum = 'system' | 'ops-user' | 'user'
type LatestDecisionPropertyDecisionOpsUserEnum = 'griffin-ops-user'
