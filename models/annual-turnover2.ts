 ...
 * 
 * @export
 * @interface AnnualTurnover2
 */
export interface AnnualTurnover2 {
    /**
     * 
     * @type {AnnualTurnoverProperty1}
     * @memberof AnnualTurnover2
     */
    'annual-turnover': AnnualTurnoverProperty1;
    /**
     * 
     * @type {string}
     * @memberof AnnualTurnover2
     */
    'claim-type': AnnualTurnover2ClaimTypeEnum;
}

type AnnualTurnover2ClaimTypeEnum = 'annual-turnover'
