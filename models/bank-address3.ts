 ...
 * 
 * @export
 * @interface BankAddress3
 */
export interface BankAddress3 {
    /**
     * The name of the [account holder](http://docs.griffin.com).
     * @type {string}
     * @memberof BankAddress3
     */
     ...
     * @memberof BankAddress3
     */
    'bank-id-code': BankAddress3BankIdCodeEnum;
    /**
     ...
     * @memberof BankAddress3
     */
    'account-number-code': BankAddress3AccountNumberCodeEnum;
}

type BankAddress3BankIdCodeEnum = 'gbdsc'
type BankAddress3AccountNumberCodeEnum = 'bban'
