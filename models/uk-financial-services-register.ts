 ...
 * 
 * @export
 * @interface UkFinancialServicesRegister
 */
export interface UkFinancialServicesRegister {
    /**
     * 
     * @type {Array<string>}
     * @memberof UkFinancialServicesRegister
     */
    'uk-regulatory-permissions': Array<UkFinancialServicesRegisterUkRegulatoryPermissionsEnum>;
    /**
