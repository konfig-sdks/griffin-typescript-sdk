...
import { Role8 } from './role8';

/**
 * 
 * @export
 * @interface OrganizationProperty2
 */
export interface OrganizationProperty2 {
    /**
     ...
     * @type {string}
     * @memberof OrganizationProperty2
     */
     ...
     * @memberof OrganizationProperty2
     */
    'organization-mode': OrganizationProperty2OrganizationModeEnum;
    /**
...
type OrganizationProperty2OrganizationModeEnum = 'test-mode' | 'live-mode'
