 ...
 * 
 * @export
 * @interface PayeesUpdatePayeeRequest
 */
export interface PayeesUpdatePayeeRequest {
    /**
     * 
     * @type {string}
     * @memberof PayeesUpdatePayeeRequest
     */
    'payee-status': PayeesUpdatePayeeRequestPayeeStatusEnum;
}

type PayeesUpdatePayeeRequestPayeeStatusEnum = 'deactivated'
