 ...
 * 
 * @export
 * @interface DebtorProperty3
 */
export interface DebtorProperty3 {
    /**
     * Must be a UK BBAN.
     * @type {string}
     * @memberof DebtorProperty3
     */
     ...
     * @memberof DebtorProperty3
     */
    'account-number-code': DebtorProperty3AccountNumberCodeEnum;
    /**
     ...
     * @memberof DebtorProperty3
     */
    'bank-id-code': DebtorProperty3BankIdCodeEnum;
    /**
...
type DebtorProperty3AccountNumberCodeEnum = 'bban'
type DebtorProperty3BankIdCodeEnum = 'gbdsc'
