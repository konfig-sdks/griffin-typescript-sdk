...
import { ManuallyCreatedByProperty } from './manually-created-by-property';

/**
 * 
 * @export
 * @interface RiskRatingRegistered
 */
export interface RiskRatingRegistered {
    /**
     * 
     * @type {string}
     * @memberof RiskRatingRegistered
     */
    'legal-person-history-event-type': RiskRatingRegisteredLegalPersonHistoryEventTypeEnum;
    /**
     ...
     * @memberof RiskRatingRegistered
     */
    'risk-rating': RiskRatingRegisteredRiskRatingEnum;
    /**
    ...
    /**
     * 
     * @type {ManuallyCreatedByProperty}
     * @memberof RiskRatingRegistered
     */
    'manually-created-by'?: ManuallyCreatedByProperty;
    /**
     * 
     * @type {string}
     * @memberof RiskRatingRegistered
     */
    'previous-risk-rating'?: RiskRatingRegisteredPreviousRiskRatingEnum;
}

type RiskRatingRegisteredLegalPersonHistoryEventTypeEnum = 'risk-rating-registered'
type RiskRatingRegisteredRiskRatingEnum = 'high-risk' | 'prohibited-risk' | 'medium-risk' | 'low-risk'
type RiskRatingRegisteredPreviousRiskRatingEnum = 'high-risk' | 'prohibited-risk' | 'medium-risk' | 'low-risk'
