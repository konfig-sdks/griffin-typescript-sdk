 ...
 * @export
 * @interface LatestDecisionProperty5
 */
export interface LatestDecisionProperty5 {
    /**
     * A link to the [verification](http://docs.griffin.com).
     * @type {string}
     * @memberof LatestDecisionProperty5
     */
     ...
     * @memberof LatestDecisionProperty5
     */
    'decision-outcome': LatestDecisionProperty5DecisionOutcomeEnum;
    /**
     * Indicates if the decision was automated or made by a human.
     * @type {string}
     * @memberof LatestDecisionProperty5
     */
    'decision-maker': LatestDecisionProperty5DecisionMakerEnum;
    /**
     ...
     * @memberof LatestDecisionProperty5
     */
    'decision-ops-user'?: LatestDecisionProperty5DecisionOpsUserEnum;
}

type LatestDecisionProperty5DecisionOutcomeEnum = 'accepted' | 'declined'
type LatestDecisionProperty5DecisionMakerEnum = 'system' | 'ops-user' | 'user'
type LatestDecisionProperty5DecisionOpsUserEnum = 'griffin-ops-user'
