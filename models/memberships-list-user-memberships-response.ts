 ...
 * 
 * @export
 * @interface MembershipsListUserMembershipsResponse
 */
export interface MembershipsListUserMembershipsResponse {
    /**
     * 
     * @type {Array<Membership1>}
     * @memberof MembershipsListUserMembershipsResponse
     */
    'memberships': Array<Membership1>;
    /**
     * 
     * @type {LinksProperty}
     * @memberof MembershipsListUserMembershipsResponse
