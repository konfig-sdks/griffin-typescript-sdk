...
export interface RiskRatingEntry {
     ...
     * @memberof RiskRatingEntry
     */
    'risk-rating': RiskRatingEntryRiskRatingEnum;
    /**
     ...
     * @memberof RiskRatingEntry
     */
    'previous-risk-rating'?: RiskRatingEntryPreviousRiskRatingEnum;
}

type RiskRatingEntryRiskRatingEnum = 'high-risk' | 'prohibited-risk' | 'medium-risk' | 'low-risk'
type RiskRatingEntryPreviousRiskRatingEnum = 'high-risk' | 'prohibited-risk' | 'medium-risk' | 'low-risk'
