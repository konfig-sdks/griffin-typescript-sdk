 ...
 * 
 * @export
 * @interface RelianceVerification1
 */
export interface RelianceVerification1 {
    /**
     * 
     * @type {Set<string>}
     * @memberof RelianceVerification1
     */
    'reliance-verification-methods': Set<RelianceVerification1RelianceVerificationMethodsEnum>;
    /**
     * 
     * @type {string}
     * @memberof RelianceVerification1
     */
    'reliance-verification-standard': RelianceVerification1RelianceVerificationStandardEnum;
    /**
     * 
     * @type {string}
     * @memberof RelianceVerification1
     */
    'claim-type': RelianceVerification1ClaimTypeEnum;
}

type RelianceVerification1RelianceVerificationMethodsEnum = 'manual-document' | 'physical' | 'electronic' | 'manual-biometric'
type RelianceVerification1RelianceVerificationStandardEnum = 'jmlsg'
type RelianceVerification1ClaimTypeEnum = 'reliance-verification'
