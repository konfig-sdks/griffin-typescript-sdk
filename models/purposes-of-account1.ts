 ...
 * 
 * @export
 * @interface PurposesOfAccount1
 */
export interface PurposesOfAccount1 {
    /**
     * 
     * @type {Set<string>}
     * @memberof PurposesOfAccount1
     */
    'purposes-of-account': Set<PurposesOfAccount1PurposesOfAccountEnum>;
    /**
     * 
     * @type {string}
     * @memberof PurposesOfAccount1
     */
    'claim-type': PurposesOfAccount1ClaimTypeEnum;
}

type PurposesOfAccount1PurposesOfAccountEnum = 'short-term-investment' | 'long-term-investment' | 'safeguarding' | 'staff-payroll' | 'client-money' | 'business-expenses' | 'receiving-payments' | 'operational-spend'
type PurposesOfAccount1ClaimTypeEnum = 'purposes-of-account'
