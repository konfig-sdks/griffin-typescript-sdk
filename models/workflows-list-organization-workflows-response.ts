 ...
 * 
 * @export
 * @interface WorkflowsListOrganizationWorkflowsResponse
 */
export interface WorkflowsListOrganizationWorkflowsResponse {
    /**
     * 
     * @type {Array<Workflow>}
     * @memberof WorkflowsListOrganizationWorkflowsResponse
     */
