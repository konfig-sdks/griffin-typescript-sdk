 ...
 * 
 * @export
 * @interface CompanyEmailAddress1
 */
export interface CompanyEmailAddress1 {
    /**
     * 
     * @type {any}
     * @memberof CompanyEmailAddress1
     */
    'email-address': any;
    /**
     * 
     ...
     * @memberof CompanyEmailAddress1
     */
    'claim-type': CompanyEmailAddress1ClaimTypeEnum;
}

type CompanyEmailAddress1ClaimTypeEnum = 'company-email-address'
