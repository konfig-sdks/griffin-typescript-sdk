...
import { AccountBalanceProperty3 } from './account-balance-property3';
import { BalanceChangeProperty } from './balance-change-property';
...
export interface AccountTransaction {
     ...
     * @memberof AccountTransaction
     */
    'balance-change-direction': AccountTransactionBalanceChangeDirectionEnum;
    /**
     * Specifies the origin of a balance change, for example a payment
     * @type {string}
     * @memberof AccountTransaction
     */
    'transaction-origin-type': AccountTransactionTransactionOriginTypeEnum;
    /**
    ...
    /**
     * 
     * @type {BalanceChangeProperty}
     * @memberof AccountTransaction
     */
    'balance-change': BalanceChangeProperty;
    /**
     * 
     * @type {AccountBalanceProperty3}
     * @memberof AccountTransaction
     */
    'account-balance': AccountBalanceProperty3;
}

type AccountTransactionBalanceChangeDirectionEnum = 'credit' | 'debit'
type AccountTransactionTransactionOriginTypeEnum = 'interest' | 'deposit' | 'fee' | 'transfer' | 'payment' | 'commission'
