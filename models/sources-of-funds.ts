 ...
 * 
 * @export
 * @interface SourcesOfFunds
 */
export interface SourcesOfFunds {
    /**
     * 
     * @type {Set<string>}
     * @memberof SourcesOfFunds
     */
    'sources-of-funds': Set<SourcesOfFundsSourcesOfFundsEnum>;
    /**
     * 
     * @type {string}
     * @memberof SourcesOfFunds
     */
    'claim-type': SourcesOfFundsClaimTypeEnum;
}

type SourcesOfFundsSourcesOfFundsEnum = 'gambling-or-lottery' | 'investments' | 'property-or-asset-sale' | 'business-income' | 'savings' | 'salary-or-bonus' | 'student-loans-or-bursary' | 'retirement-or-pension' | 'legal-settlement' | 'family-or-gifted' | 'loan' | 'inheritance'
type SourcesOfFundsClaimTypeEnum = 'sources-of-funds'
