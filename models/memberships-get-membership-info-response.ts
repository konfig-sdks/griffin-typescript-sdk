...
import { OrganizationProperty } from './organization-property';
 ...
 * 
 * @export
 * @interface MembershipsGetMembershipInfoResponse
 */
export interface MembershipsGetMembershipInfoResponse {
    /**
     * Link to the [membership](http://docs.griffin.com).
     * @type {string}
     * @memberof MembershipsGetMembershipInfoResponse
     */
