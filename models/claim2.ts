...
import { AlternativeNumber1 } from './alternative-number1';
import { AnnualTurnover3 } from './annual-turnover3';
import { AnnualTurnoverProperty2 } from './annual-turnover-property2';
import { BusinessAddress3 } from './business-address3';
import { BusinessAddressProperty2 } from './business-address-property2';
import { BusinessDescription1 } from './business-description1';
import { BusinessName1 } from './business-name1';
import { CompanyEmailAddress1 } from './company-email-address1';
import { CompanyTelephoneNumber1 } from './company-telephone-number1';
import { CompanyWebsite1 } from './company-website1';
import { ContactDetails1 } from './contact-details1';
import { Director3 } from './director3';
import { Employment3 } from './employment3';
import { IncomeProperty2 } from './income-property2';
import { IndividualIdentity1 } from './individual-identity1';
import { IndividualIncome3 } from './individual-income3';
import { IndividualPurposesOfAccount1 } from './individual-purposes-of-account1';
import { IndividualResidence3 } from './individual-residence3';
import { IndividualSourcesOfFunds1 } from './individual-sources-of-funds1';
import { InitialDeposit3 } from './initial-deposit3';
import { InitialDepositProperty2 } from './initial-deposit-property2';
import { InternationalOperationsCountries1 } from './international-operations-countries1';
...
import { NominalPersonWithSignificantControl3 } from './nominal-person-with-significant-control3';
import { PersonWithSignificantControl3 } from './person-with-significant-control3';
import { PurposesOfAccount1 } from './purposes-of-account1';
import { RelianceVerification1 } from './reliance-verification1';
import { SicCodes3 } from './sic-codes3';
import { SocialMedia1 } from './social-media1';
import { SoleTrader3 } from './sole-trader3';
import { SourcesOfFunds1 } from './sources-of-funds1';
import { TaxIdentificationNumber1 } from './tax-identification-number1';
import { TaxResidency1 } from './tax-residency1';
import { TradingAddress3 } from './trading-address3';
import { TradingAddressProperty5 } from './trading-address-property5';
import { TradingName1 } from './trading-name1';
import { UkCompanyRegister3 } from './uk-company-register3';
import { UkFinancialServicesRegister1 } from './uk-financial-services-register1';

/**
 * @type Claim2
 * @export
 */
export type Claim2 = MobileNumber1 | IndividualIdentity1 | SoleTrader3 | UkCompanyRegister3 | IndividualIncome3 | InitialDeposit3 | InternationalPaymentsCountries1 | CompanyTelephoneNumber1 | PersonWithSignificantControl3 | CompanyEmailAddress1 | TaxResidency1 | UkFinancialServicesRegister1 | BusinessDescription1 | IndividualSourcesOfFunds1 | NominalPersonWithSignificantControl3 | BusinessAddress3 | Employment3 | AnnualTurnover3 | PurposesOfAccount1 | SicCodes3 | InternationalOperationsCountries1 | SourcesOfFunds1 | ContactDetails1 | RelianceVerification1 | BusinessName1 | IndividualPurposesOfAccount1 | Nationality1 | TradingName1 | SocialMedia1 | TradingAddress3 | CompanyWebsite1 | Director3 | AlternativeNumber1 | TaxIdentificationNumber1 | IndividualResidence3;
