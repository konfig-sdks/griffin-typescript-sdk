 ...
 * 
 * @export
 * @interface UkFinancialServicesRegister1
 */
export interface UkFinancialServicesRegister1 {
    /**
     * 
     * @type {Array<string>}
     * @memberof UkFinancialServicesRegister1
     */
    'uk-regulatory-permissions': Array<UkFinancialServicesRegister1UkRegulatoryPermissionsEnum>;
    /**
