...
export interface PersonWithSignificantControl {
     ...
     * @type {string}
     * @memberof PersonWithSignificantControl
     */
     ...
     * @memberof PersonWithSignificantControl
     */
    'claim-type': PersonWithSignificantControlClaimTypeEnum;
}

type PersonWithSignificantControlClaimTypeEnum = 'person-with-significant-control'
