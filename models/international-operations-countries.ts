 ...
 * 
 * @export
 * @interface InternationalOperationsCountries
 */
export interface InternationalOperationsCountries {
    /**
     * 
     * @type {Array<any>}
     * @memberof InternationalOperationsCountries
     */
     ...
     * @memberof InternationalOperationsCountries
     */
    'claim-type': InternationalOperationsCountriesClaimTypeEnum;
}

type InternationalOperationsCountriesClaimTypeEnum = 'international-operations-countries'
