 ...
 * 
 * @export
 * @interface PersonWithSignificantControl5
 */
export interface PersonWithSignificantControl5 {
    /**
     * A contextual link to the [legal person](http://docs.griffin.com).
     * @type {string}
     * @memberof PersonWithSignificantControl5
     */
     ...
     * @memberof PersonWithSignificantControl5
     */
    'claim-type': PersonWithSignificantControl5ClaimTypeEnum;
}

type PersonWithSignificantControl5ClaimTypeEnum = 'person-with-significant-control'
