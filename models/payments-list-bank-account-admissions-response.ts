 ...
 * 
 * @export
 * @interface PaymentsListBankAccountAdmissionsResponse
 */
export interface PaymentsListBankAccountAdmissionsResponse {
    /**
     * 
     * @type {Array<Admission>}
     * @memberof PaymentsListBankAccountAdmissionsResponse
     */
