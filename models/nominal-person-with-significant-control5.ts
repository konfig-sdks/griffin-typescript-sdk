 ...
 * 
 * @export
 * @interface NominalPersonWithSignificantControl5
 */
export interface NominalPersonWithSignificantControl5 {
    /**
     * A contextual link to the [legal person](http://docs.griffin.com).
     * @type {string}
     * @memberof NominalPersonWithSignificantControl5
     */
     ...
     * @memberof NominalPersonWithSignificantControl5
     */
    'claim-type': NominalPersonWithSignificantControl5ClaimTypeEnum;
}

type NominalPersonWithSignificantControl5ClaimTypeEnum = 'nominal-person-with-significant-control'
