...
import { ClientMoneyAccount } from './client-money-account';
import { OperationalAccount } from './operational-account';
import { SafeguardingAccount } from './safeguarding-account';
import { SavingsAccount } from './savings-account';

/**
 * @type BankAccountsCreateNewAccountRequest
 * @export
 */
export type BankAccountsCreateNewAccountRequest = SavingsAccount | ClientMoneyAccount | SafeguardingAccount | OperationalAccount;
