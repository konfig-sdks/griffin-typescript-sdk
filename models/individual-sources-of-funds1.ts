 ...
 * 
 * @export
 * @interface IndividualSourcesOfFunds1
 */
export interface IndividualSourcesOfFunds1 {
    /**
     * 
     * @type {Set<string>}
     * @memberof IndividualSourcesOfFunds1
     */
    'individual-sources-of-funds': Set<IndividualSourcesOfFunds1IndividualSourcesOfFundsEnum>;
    /**
     * 
     * @type {string}
     * @memberof IndividualSourcesOfFunds1
     */
    'claim-type': IndividualSourcesOfFunds1ClaimTypeEnum;
}

type IndividualSourcesOfFunds1IndividualSourcesOfFundsEnum = 'gambling-or-lottery' | 'investments' | 'property-or-asset-sale' | 'savings' | 'salary-or-bonus' | 'student-loans-or-bursary' | 'retirement-or-pension' | 'legal-settlement' | 'family-or-gifted' | 'loan' | 'inheritance'
type IndividualSourcesOfFunds1ClaimTypeEnum = 'individual-sources-of-funds'
