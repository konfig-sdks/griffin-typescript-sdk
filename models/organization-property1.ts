...
import { Role5 } from './role5';

/**
 * 
 * @export
 * @interface OrganizationProperty1
 */
export interface OrganizationProperty1 {
    /**
     ...
     * @type {string}
     * @memberof OrganizationProperty1
     */
     ...
     * @memberof OrganizationProperty1
     */
    'organization-mode': OrganizationProperty1OrganizationModeEnum;
    /**
...
type OrganizationProperty1OrganizationModeEnum = 'test-mode' | 'live-mode'
