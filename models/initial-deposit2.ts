 ...
 * 
 * @export
 * @interface InitialDeposit2
 */
export interface InitialDeposit2 {
    /**
     * 
     * @type {InitialDepositProperty1}
     * @memberof InitialDeposit2
     */
    'initial-deposit': InitialDepositProperty1;
    /**
     * 
     * @type {string}
     * @memberof InitialDeposit2
     */
    'claim-type': InitialDeposit2ClaimTypeEnum;
}

type InitialDeposit2ClaimTypeEnum = 'initial-deposit'
