...
import { BothBuildingNameAndBuildingNumber } from './both-building-name-and-building-number';
import { OnlyBuildingName } from './only-building-name';
import { OnlyBuildingNumber } from './only-building-number';

/**
 * @type BusinessAddressProperty2
 * @export
 */
export type BusinessAddressProperty2 = BothBuildingNameAndBuildingNumber | OnlyBuildingName | OnlyBuildingNumber;
