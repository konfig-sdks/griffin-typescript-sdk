 ...
 * 
 * @export
 * @interface RelianceOnboardingCreateApplicationResponse
 */
export interface RelianceOnboardingCreateApplicationResponse {
    /**
     * Link to the onboarding application.
     * @type {string}
     * @memberof RelianceOnboardingCreateApplicationResponse
     */
     ...
     * @memberof RelianceOnboardingCreateApplicationResponse
     */
    'onboarding-application-status': RelianceOnboardingCreateApplicationResponseOnboardingApplicationStatusEnum;
}

type RelianceOnboardingCreateApplicationResponseOnboardingApplicationStatusEnum = 'processing' | 'submitted' | 'complete'
