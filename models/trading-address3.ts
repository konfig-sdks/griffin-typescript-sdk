 ...
 * 
 * @export
 * @interface TradingAddress3
 */
export interface TradingAddress3 {
    /**
     * 
     * @type {TradingAddressProperty5}
     * @memberof TradingAddress3
     */
    'trading-address': TradingAddressProperty5;
    /**
     * 
     * @type {string}
     * @memberof TradingAddress3
     */
    'claim-type': TradingAddress3ClaimTypeEnum;
}

type TradingAddress3ClaimTypeEnum = 'trading-address'
