 ...
 * 
 * @export
 * @interface InitialDepositProperty
 */
export interface InitialDepositProperty {
    /**
     * 
     * @type {string}
     * @memberof InitialDepositProperty
     */
    'currency': InitialDepositPropertyCurrencyEnum;
    /**
...
type InitialDepositPropertyCurrencyEnum = 'GBP'
