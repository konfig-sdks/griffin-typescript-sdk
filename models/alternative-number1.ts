 ...
 * 
 * @export
 * @interface AlternativeNumber1
 */
export interface AlternativeNumber1 {
    /**
     * 
     * @type {any}
     * @memberof AlternativeNumber1
     */
     ...
     * @memberof AlternativeNumber1
     */
    'claim-type': AlternativeNumber1ClaimTypeEnum;
}

type AlternativeNumber1ClaimTypeEnum = 'alternative-number'
