...
import { LatestDecisionProperty2 } from './latest-decision-property2';

/**
 * 
 * @export
 * @interface LegalPersonsUpdateLegalPersonResponse
 */
export interface LegalPersonsUpdateLegalPersonResponse {
    /**
     * 
     * @type {LatestDecisionProperty2}
     * @memberof LegalPersonsUpdateLegalPersonResponse
     */
    'latest-decision'?: LatestDecisionProperty2;
    /**
     * Specifies if the legal person is an `individual` or a `corporation`.
     * @type {string}
     * @memberof LegalPersonsUpdateLegalPersonResponse
     */
    'legal-person-type': LegalPersonsUpdateLegalPersonResponseLegalPersonTypeEnum;
    /**
     ...
     * @memberof LegalPersonsUpdateLegalPersonResponse
     */
    'application-status'?: LegalPersonsUpdateLegalPersonResponseApplicationStatusEnum;
    /**
...
type LegalPersonsUpdateLegalPersonResponseLegalPersonTypeEnum = 'individual' | 'corporation'
type LegalPersonsUpdateLegalPersonResponseApplicationStatusEnum = 'referred' | 'errored' | 'declined' | 'submitted' | 'accepted'
