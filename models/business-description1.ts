 ...
 * 
 * @export
 * @interface BusinessDescription1
 */
export interface BusinessDescription1 {
    /**
     * 
     * @type {string}
     * @memberof BusinessDescription1
     */
     ...
     * @memberof BusinessDescription1
     */
    'claim-type': BusinessDescription1ClaimTypeEnum;
}

type BusinessDescription1ClaimTypeEnum = 'business-description'
