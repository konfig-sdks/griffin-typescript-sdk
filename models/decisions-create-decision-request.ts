 ...
 * 
 * @export
 * @interface DecisionsCreateDecisionRequest
 */
export interface DecisionsCreateDecisionRequest {
    /**
     * A link to the [verification](http://docs.griffin.com).
     * @type {string}
     * @memberof DecisionsCreateDecisionRequest
     */
     ...
     * @memberof DecisionsCreateDecisionRequest
     */
    'decision-outcome': DecisionsCreateDecisionRequestDecisionOutcomeEnum;
    /**
...
type DecisionsCreateDecisionRequestDecisionOutcomeEnum = 'accepted' | 'declined'
