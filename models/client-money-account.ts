 ...
 * 
 * @export
 * @interface ClientMoneyAccount
 */
export interface ClientMoneyAccount {
    /**
     * 
     * @type {string}
     * @memberof ClientMoneyAccount
     */
    'bank-product-type': ClientMoneyAccountBankProductTypeEnum;
}

type ClientMoneyAccountBankProductTypeEnum = 'client-money-account'
