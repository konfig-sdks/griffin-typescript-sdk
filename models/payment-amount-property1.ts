 ...
 * @export
 * @interface PaymentAmountProperty1
 */
export interface PaymentAmountProperty1 {
    /**
     * 
     * @type {string}
     * @memberof PaymentAmountProperty1
     */
    'currency': PaymentAmountProperty1CurrencyEnum;
    /**
...
type PaymentAmountProperty1CurrencyEnum = 'GBP'
