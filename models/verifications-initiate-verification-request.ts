 ...
 * 
 * @export
 * @interface VerificationsInitiateVerificationRequest
 */
export interface VerificationsInitiateVerificationRequest {
    /**
     * A link to the [workflow](http://docs.griffin.com).
     * @type {string}
     * @memberof VerificationsInitiateVerificationRequest
     */
    'workflow-url': string;
}
