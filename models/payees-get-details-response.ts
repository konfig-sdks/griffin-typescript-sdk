 ...
 * 
 * @export
 * @interface PayeesGetDetailsResponse
 */
export interface PayeesGetDetailsResponse {
    /**
     * Link to the [payee](http://docs.griffin.com).
     * @type {string}
     * @memberof PayeesGetDetailsResponse
     */
    'payee-url': string;
    /**
     * Must be a UK BBAN.
     ...
     * @memberof PayeesGetDetailsResponse
     */
    'payee-status': PayeesGetDetailsResponsePayeeStatusEnum;
    /**
...
type PayeesGetDetailsResponsePayeeStatusEnum = 'deactivated' | 'active'
