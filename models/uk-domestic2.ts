 ...
 * 
 * @export
 * @interface UkDomestic2
 */
export interface UkDomestic2 {
    /**
     * The name of the [account holder](http://docs.griffin.com).
     * @type {string}
     * @memberof UkDomestic2
     */
     ...
     * @memberof UkDomestic2
     */
    'account-number-code': UkDomestic2AccountNumberCodeEnum;
    /**
     ...
     * @memberof UkDomestic2
     */
    'bank-id-code': UkDomestic2BankIdCodeEnum;
    /**
     * 
     * @type {string}
     * @memberof UkDomestic2
     */
    'creditor-type': UkDomestic2CreditorTypeEnum;
}

type UkDomestic2AccountNumberCodeEnum = 'bban'
type UkDomestic2BankIdCodeEnum = 'gbdsc'
type UkDomestic2CreditorTypeEnum = 'uk-domestic'
