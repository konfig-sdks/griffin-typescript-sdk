 ...
 * 
 * @export
 * @interface PooledAccountMembershipManageLegalPersonsResponse
 */
export interface PooledAccountMembershipManageLegalPersonsResponse {
    /**
     * Link to the list of [pool members](http://docs.griffin.com) associated with this account.
     * @type {string}
     * @memberof PooledAccountMembershipManageLegalPersonsResponse
     */
