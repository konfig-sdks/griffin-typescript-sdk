 ...
 * 
 * @export
 * @interface UkCompanyRegister
 */
export interface UkCompanyRegister {
    /**
     * 
     * @type {any}
     * @memberof UkCompanyRegister
     */
    'email-address'?: any;
    /**
     * 
     ...
     * @memberof UkCompanyRegister
     */
    'claim-type': UkCompanyRegisterClaimTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof UkCompanyRegister
     ...
     * @memberof UkCompanyRegister
     */
    'corporation-type': UkCompanyRegisterCorporationTypeEnum;
    /**
     * 
     * @type {any}
     * @memberof UkCompanyRegister
