 ...
 * 
 * @export
 * @interface UkDomestic3
 */
export interface UkDomestic3 {
    /**
     * The name of the [account holder](http://docs.griffin.com).
     * @type {string}
     * @memberof UkDomestic3
     */
     ...
     * @memberof UkDomestic3
     */
    'account-number-code': UkDomestic3AccountNumberCodeEnum;
    /**
     ...
     * @memberof UkDomestic3
     */
    'bank-id-code': UkDomestic3BankIdCodeEnum;
    /**
     * 
     * @type {string}
     * @memberof UkDomestic3
     */
    'creditor-type': UkDomestic3CreditorTypeEnum;
}

type UkDomestic3AccountNumberCodeEnum = 'bban'
type UkDomestic3BankIdCodeEnum = 'gbdsc'
type UkDomestic3CreditorTypeEnum = 'uk-domestic'
