 ...
 * 
 * @export
 * @interface TaxIdentificationNumber1
 */
export interface TaxIdentificationNumber1 {
    /**
     * 
     * @type {string}
     * @memberof TaxIdentificationNumber1
     */
     ...
     * @memberof TaxIdentificationNumber1
     */
    'claim-type': TaxIdentificationNumber1ClaimTypeEnum;
}

type TaxIdentificationNumber1ClaimTypeEnum = 'tax-identification-number'
