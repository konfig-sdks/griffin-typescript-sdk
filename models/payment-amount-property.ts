 ...
 * @export
 * @interface PaymentAmountProperty
 */
export interface PaymentAmountProperty {
    /**
     * 
     * @type {string}
     * @memberof PaymentAmountProperty
     */
    'currency': PaymentAmountPropertyCurrencyEnum;
    /**
...
type PaymentAmountPropertyCurrencyEnum = 'GBP'
