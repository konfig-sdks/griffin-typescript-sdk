...
import { LatestDecisionProperty3 } from './latest-decision-property3';

/**
 * 
 * @export
 * @interface LegalPerson1
 */
export interface LegalPerson1 {
    /**
     * 
     * @type {LatestDecisionProperty3}
     * @memberof LegalPerson1
     */
    'latest-decision'?: LatestDecisionProperty3;
    /**
     * Specifies if the legal person is an `individual` or a `corporation`.
     * @type {string}
     * @memberof LegalPerson1
     */
    'legal-person-type': LegalPerson1LegalPersonTypeEnum;
    /**
     ...
     * @memberof LegalPerson1
     */
    'application-status'?: LegalPerson1ApplicationStatusEnum;
    /**
...
type LegalPerson1LegalPersonTypeEnum = 'individual' | 'corporation'
type LegalPerson1ApplicationStatusEnum = 'referred' | 'errored' | 'declined' | 'submitted' | 'accepted'
