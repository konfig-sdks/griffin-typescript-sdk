...
import { AccountBalanceProperty } from './account-balance-property';
import { AvailableBalanceProperty } from './available-balance-property';
import { BankAddress } from './bank-address';

/**
 * 
 * @export
 * @interface BankAccountsGetAccountResponse
 */
export interface BankAccountsGetAccountResponse {
    /**
     * Link to the [payment submissions](http://docs.griffin.com) debiting from this account.
     * @type {string}
     * @memberof BankAccountsGetAccountResponse
     */
     ...
     * @memberof BankAccountsGetAccountResponse
     */
    'bank-product-type': BankAccountsGetAccountResponseBankProductTypeEnum;
    /**
     ...
     * @memberof BankAccountsGetAccountResponse
     */
    'account-status': BankAccountsGetAccountResponseAccountStatusEnum;
    /**
     * Specifies the type of client money account.
     * @type {string}
     * @memberof BankAccountsGetAccountResponse
     */
    'client-money-type'?: BankAccountsGetAccountResponseClientMoneyTypeEnum;
    /**
    ...
    /**
     * 
     * @type {AvailableBalanceProperty}
     * @memberof BankAccountsGetAccountResponse
     */
    'available-balance': AvailableBalanceProperty;
    /**
     ...
     * @type {Array<BankAddress>}
     * @memberof BankAccountsGetAccountResponse
     */
    'bank-addresses'?: Array<BankAddress>;
    /**
    ...
    /**
     * 
     * @type {AccountBalanceProperty}
     * @memberof BankAccountsGetAccountResponse
     */
    'account-balance': AccountBalanceProperty;
    /**
     * Specifies the type of savings account.
     * @type {string}
     * @memberof BankAccountsGetAccountResponse
     */
    'savings-type'?: BankAccountsGetAccountResponseSavingsTypeEnum;
}

type BankAccountsGetAccountResponseBankProductTypeEnum = 'savings-account' | 'client-money-account' | 'safeguarding-account' | 'operational-account'
type BankAccountsGetAccountResponseAccountStatusEnum = 'closing' | 'open' | 'closed' | 'opening'
type BankAccountsGetAccountResponseClientMoneyTypeEnum = 'designated-client-fund' | 'designated-client-money' | 'general-client-money'
type BankAccountsGetAccountResponseSavingsTypeEnum = 'easy-access'
