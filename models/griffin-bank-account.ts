...
export interface GriffinBankAccount {
     ...
     * @memberof GriffinBankAccount
     */
    'creditor-type': GriffinBankAccountCreditorTypeEnum;
}

type GriffinBankAccountCreditorTypeEnum = 'griffin-bank-account'
