 ...
 * 
 * @export
 * @interface InitialDepositProperty1
 */
export interface InitialDepositProperty1 {
    /**
     * 
     * @type {string}
     * @memberof InitialDepositProperty1
     */
    'currency': InitialDepositProperty1CurrencyEnum;
    /**
...
type InitialDepositProperty1CurrencyEnum = 'GBP'
