 ...
 * 
 * @export
 * @interface IndividualResidence5
 */
export interface IndividualResidence5 {
    /**
     * 
     * @type {string}
     * @memberof IndividualResidence5
     */
    'street-name': string;
    /**
     * 
     ...
     * @memberof IndividualResidence5
     */
    'claim-type': IndividualResidence5ClaimTypeEnum;
}

type IndividualResidence5ClaimTypeEnum = 'individual-residence'
