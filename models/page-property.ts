...
import { EstimatedTotalProperty } from './estimated-total-property';
...
export interface PageProperty {
    /**
     * Total number of items. Present when the total number of items in the full result set is less than 10,000.
     * @type {number}
    ...
    /**
     * 
     * @type {EstimatedTotalProperty}
     * @memberof PageProperty
     */
    'estimated-total'?: EstimatedTotalProperty;
}
