 ...
 * 
 * @export
 * @interface RelianceVerification
 */
export interface RelianceVerification {
    /**
     * 
     * @type {Set<string>}
     * @memberof RelianceVerification
     */
    'reliance-verification-methods': Set<RelianceVerificationRelianceVerificationMethodsEnum>;
    /**
     * 
     * @type {string}
     * @memberof RelianceVerification
     */
    'reliance-verification-standard': RelianceVerificationRelianceVerificationStandardEnum;
    /**
     * 
     * @type {string}
     * @memberof RelianceVerification
     */
    'claim-type': RelianceVerificationClaimTypeEnum;
}

type RelianceVerificationRelianceVerificationMethodsEnum = 'manual-document' | 'physical' | 'electronic' | 'manual-biometric'
type RelianceVerificationRelianceVerificationStandardEnum = 'jmlsg'
type RelianceVerificationClaimTypeEnum = 'reliance-verification'
