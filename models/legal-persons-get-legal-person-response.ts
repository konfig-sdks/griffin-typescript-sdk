...
import { LatestDecisionProperty1 } from './latest-decision-property1';

/**
 * 
 * @export
 * @interface LegalPersonsGetLegalPersonResponse
 */
export interface LegalPersonsGetLegalPersonResponse {
    /**
     * 
     * @type {LatestDecisionProperty1}
     * @memberof LegalPersonsGetLegalPersonResponse
     */
    'latest-decision'?: LatestDecisionProperty1;
    /**
     * Specifies if the legal person is an `individual` or a `corporation`.
     * @type {string}
     * @memberof LegalPersonsGetLegalPersonResponse
     */
    'legal-person-type': LegalPersonsGetLegalPersonResponseLegalPersonTypeEnum;
    /**
     ...
     * @memberof LegalPersonsGetLegalPersonResponse
     */
    'application-status'?: LegalPersonsGetLegalPersonResponseApplicationStatusEnum;
    /**
...
type LegalPersonsGetLegalPersonResponseLegalPersonTypeEnum = 'individual' | 'corporation'
type LegalPersonsGetLegalPersonResponseApplicationStatusEnum = 'referred' | 'errored' | 'declined' | 'submitted' | 'accepted'
