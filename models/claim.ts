...
import { AnnualTurnover1 } from './annual-turnover1';
import { AnnualTurnoverProperty } from './annual-turnover-property';
import { BusinessAddress1 } from './business-address1';
import { BusinessAddressProperty } from './business-address-property';
...
import { Employment1 } from './employment1';
import { IncomeProperty } from './income-property';
import { IndividualIdentity1 } from './individual-identity1';
import { IndividualIncome1 } from './individual-income1';
import { IndividualPurposesOfAccount1 } from './individual-purposes-of-account1';
import { IndividualResidence1 } from './individual-residence1';
import { IndividualSourcesOfFunds1 } from './individual-sources-of-funds1';
import { InitialDeposit1 } from './initial-deposit1';
import { InitialDepositProperty } from './initial-deposit-property';
...
import { NominalPersonWithSignificantControl1 } from './nominal-person-with-significant-control1';
import { PersonWithSignificantControl1 } from './person-with-significant-control1';
import { PurposesOfAccount1 } from './purposes-of-account1';
import { RelianceVerification1 } from './reliance-verification1';
import { SicCodes1 } from './sic-codes1';
import { SocialMedia1 } from './social-media1';
import { SoleTrader1 } from './sole-trader1';
...
import { TradingAddress1 } from './trading-address1';
import { TradingAddressProperty1 } from './trading-address-property1';
import { TradingName1 } from './trading-name1';
import { UkCompanyRegister1 } from './uk-company-register1';
 ...
 * @export
 */
export type Claim = MobileNumber1 | IndividualIdentity1 | SoleTrader1 | UkCompanyRegister1 | IndividualIncome1 | InitialDeposit1 | InternationalPaymentsCountries1 | CompanyTelephoneNumber1 | PersonWithSignificantControl1 | CompanyEmailAddress1 | TaxResidency1 | UkFinancialServicesRegister1 | BusinessDescription1 | IndividualSourcesOfFunds1 | NominalPersonWithSignificantControl1 | BusinessAddress1 | Employment1 | AnnualTurnover1 | PurposesOfAccount1 | SicCodes1 | InternationalOperationsCountries1 | SourcesOfFunds1 | ContactDetails1 | RelianceVerification1 | BusinessName1 | IndividualPurposesOfAccount1 | Nationality1 | TradingName1 | SocialMedia1 | TradingAddress1 | CompanyWebsite1 | Director1 | AlternativeNumber1 | TaxIdentificationNumber1 | IndividualResidence1;
