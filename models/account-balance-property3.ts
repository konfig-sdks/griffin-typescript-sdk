 ...
 * @export
 * @interface AccountBalanceProperty3
 */
export interface AccountBalanceProperty3 {
    /**
     * 
     * @type {string}
     * @memberof AccountBalanceProperty3
     */
    'currency': AccountBalanceProperty3CurrencyEnum;
    /**
...
type AccountBalanceProperty3CurrencyEnum = 'GBP'
