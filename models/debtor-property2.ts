 ...
 * 
 * @export
 * @interface DebtorProperty2
 */
export interface DebtorProperty2 {
    /**
     * Must be a UK BBAN.
     * @type {string}
     * @memberof DebtorProperty2
     */
     ...
     * @memberof DebtorProperty2
     */
    'account-number-code': DebtorProperty2AccountNumberCodeEnum;
    /**
     ...
     * @memberof DebtorProperty2
     */
    'bank-id-code': DebtorProperty2BankIdCodeEnum;
    /**
...
type DebtorProperty2AccountNumberCodeEnum = 'bban'
type DebtorProperty2BankIdCodeEnum = 'gbdsc'
