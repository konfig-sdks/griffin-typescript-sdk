...
import { AccountBalanceProperty1 } from './account-balance-property1';
import { AvailableBalanceProperty1 } from './available-balance-property1';
import { BankAddress1 } from './bank-address1';

/**
 * 
 * @export
 * @interface BankAccountsUpdateBankAccountResponse
 */
export interface BankAccountsUpdateBankAccountResponse {
    /**
     * Link to the [payment submissions](http://docs.griffin.com) debiting from this account.
     * @type {string}
     * @memberof BankAccountsUpdateBankAccountResponse
     */
     ...
     * @memberof BankAccountsUpdateBankAccountResponse
     */
    'bank-product-type': BankAccountsUpdateBankAccountResponseBankProductTypeEnum;
    /**
     ...
     * @memberof BankAccountsUpdateBankAccountResponse
     */
    'account-status': BankAccountsUpdateBankAccountResponseAccountStatusEnum;
    /**
     * Specifies the type of client money account.
     * @type {string}
     * @memberof BankAccountsUpdateBankAccountResponse
     */
    'client-money-type'?: BankAccountsUpdateBankAccountResponseClientMoneyTypeEnum;
    /**
    ...
    /**
     * 
     * @type {AvailableBalanceProperty1}
     * @memberof BankAccountsUpdateBankAccountResponse
     */
    'available-balance': AvailableBalanceProperty1;
    /**
     ...
     * @type {Array<BankAddress1>}
     * @memberof BankAccountsUpdateBankAccountResponse
     */
    'bank-addresses'?: Array<BankAddress1>;
    /**
    ...
    /**
     * 
     * @type {AccountBalanceProperty1}
     * @memberof BankAccountsUpdateBankAccountResponse
     */
    'account-balance': AccountBalanceProperty1;
    /**
     * Specifies the type of savings account.
     * @type {string}
     * @memberof BankAccountsUpdateBankAccountResponse
     */
    'savings-type'?: BankAccountsUpdateBankAccountResponseSavingsTypeEnum;
}

type BankAccountsUpdateBankAccountResponseBankProductTypeEnum = 'savings-account' | 'client-money-account' | 'safeguarding-account' | 'operational-account'
type BankAccountsUpdateBankAccountResponseAccountStatusEnum = 'closing' | 'open' | 'closed' | 'opening'
type BankAccountsUpdateBankAccountResponseClientMoneyTypeEnum = 'designated-client-fund' | 'designated-client-money' | 'general-client-money'
type BankAccountsUpdateBankAccountResponseSavingsTypeEnum = 'easy-access'
