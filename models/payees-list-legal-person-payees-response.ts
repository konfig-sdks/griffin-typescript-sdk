...
import { Payee4 } from './payee4';

/**
 * 
 * @export
 * @interface PayeesListLegalPersonPayeesResponse
 */
export interface PayeesListLegalPersonPayeesResponse {
    /**
     * 
     * @type {Array<Payee4>}
     * @memberof PayeesListLegalPersonPayeesResponse
     */
    'payees': Array<Payee4>;
    /**
     * 
