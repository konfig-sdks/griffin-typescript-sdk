...
import { AccountBalanceProperty4 } from './account-balance-property4';
import { BalanceChangeProperty1 } from './balance-change-property1';

/**
 * 
 * @export
 * @interface TransactionsGetTransactionByIdResponse
 */
export interface TransactionsGetTransactionByIdResponse {
    /**
     * Link to the transaction resource.
     * @type {string}
     * @memberof TransactionsGetTransactionByIdResponse
     */
     ...
     * @memberof TransactionsGetTransactionByIdResponse
     */
    'balance-change-direction': TransactionsGetTransactionByIdResponseBalanceChangeDirectionEnum;
    /**
     * Specifies the origin of a balance change, for example a payment
     * @type {string}
     * @memberof TransactionsGetTransactionByIdResponse
     */
    'transaction-origin-type': TransactionsGetTransactionByIdResponseTransactionOriginTypeEnum;
    /**
    ...
    /**
     * 
     * @type {BalanceChangeProperty1}
     * @memberof TransactionsGetTransactionByIdResponse
     */
    'balance-change': BalanceChangeProperty1;
    /**
     * 
     * @type {AccountBalanceProperty4}
     * @memberof TransactionsGetTransactionByIdResponse
     */
    'account-balance': AccountBalanceProperty4;
}

type TransactionsGetTransactionByIdResponseBalanceChangeDirectionEnum = 'credit' | 'debit'
type TransactionsGetTransactionByIdResponseTransactionOriginTypeEnum = 'interest' | 'deposit' | 'fee' | 'transfer' | 'payment' | 'commission'
