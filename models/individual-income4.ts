 ...
 * 
 * @export
 * @interface IndividualIncome4
 */
export interface IndividualIncome4 {
    /**
     * 
     * @type {IncomeProperty3}
     * @memberof IndividualIncome4
     */
    'income': IncomeProperty3;
    /**
     * 
     * @type {string}
     * @memberof IndividualIncome4
     */
    'claim-type': IndividualIncome4ClaimTypeEnum;
}

type IndividualIncome4ClaimTypeEnum = 'individual-income'
