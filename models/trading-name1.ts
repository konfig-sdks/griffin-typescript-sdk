 ...
 * 
 * @export
 * @interface TradingName1
 */
export interface TradingName1 {
    /**
     * 
     * @type {string}
     * @memberof TradingName1
     */
    'trading-name': string;
    /**
     * 
     ...
     * @memberof TradingName1
     */
    'claim-type': TradingName1ClaimTypeEnum;
}

type TradingName1ClaimTypeEnum = 'trading-name'
