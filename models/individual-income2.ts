 ...
 * 
 * @export
 * @interface IndividualIncome2
 */
export interface IndividualIncome2 {
    /**
     * 
     * @type {IncomeProperty1}
     * @memberof IndividualIncome2
     */
    'income': IncomeProperty1;
    /**
     * 
     * @type {string}
     * @memberof IndividualIncome2
     */
    'claim-type': IndividualIncome2ClaimTypeEnum;
}

type IndividualIncome2ClaimTypeEnum = 'individual-income'
