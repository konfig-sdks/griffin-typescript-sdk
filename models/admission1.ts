 ...
 * 
 * @export
 * @interface Admission1
 */
export interface Admission1 {
    /**
     * Specifies the progress of the inbound payment.
     * @type {string}
     * @memberof Admission1
     */
    'admission-status': Admission1AdmissionStatusEnum;
    /**
     * 
...
type Admission1AdmissionStatusEnum = 'processing' | 'returned' | 'delivered'
