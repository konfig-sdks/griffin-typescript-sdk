 ...
 * 
 * @export
 * @interface GriffinBankAccount4
 */
export interface GriffinBankAccount4 {
    /**
     * Link to the bank account resource.
     * @type {string}
     * @memberof GriffinBankAccount4
     */
    'account-url': string;
    /**
     * 
     ...
     * @memberof GriffinBankAccount4
     */
    'creditor-type': GriffinBankAccount4CreditorTypeEnum;
}

type GriffinBankAccount4CreditorTypeEnum = 'griffin-bank-account'
