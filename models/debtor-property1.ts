 ...
 * 
 * @export
 * @interface DebtorProperty1
 */
export interface DebtorProperty1 {
    /**
     * Must be a UK BBAN.
     * @type {string}
     * @memberof DebtorProperty1
     */
     ...
     * @memberof DebtorProperty1
     */
    'account-number-code': DebtorProperty1AccountNumberCodeEnum;
    /**
     ...
     * @memberof DebtorProperty1
     */
    'bank-id-code': DebtorProperty1BankIdCodeEnum;
    /**
...
type DebtorProperty1AccountNumberCodeEnum = 'bban'
type DebtorProperty1BankIdCodeEnum = 'gbdsc'
