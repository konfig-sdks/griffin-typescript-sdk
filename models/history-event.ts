...
import { DecisionCreated } from './decision-created';
import { ManuallyCreatedByProperty } from './manually-created-by-property';
import { RiskRatingRegistered } from './risk-rating-registered';

/**
 * @type HistoryEvent
 * @export
 */
export type HistoryEvent = RiskRatingRegistered | DecisionCreated;
