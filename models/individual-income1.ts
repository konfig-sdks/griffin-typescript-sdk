 ...
 * 
 * @export
 * @interface IndividualIncome1
 */
export interface IndividualIncome1 {
    /**
     * 
     * @type {IncomeProperty}
     * @memberof IndividualIncome1
     */
     ...
     * @memberof IndividualIncome1
     */
    'claim-type': IndividualIncome1ClaimTypeEnum;
}

type IndividualIncome1ClaimTypeEnum = 'individual-income'
