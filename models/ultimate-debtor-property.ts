 ...
 * 
 * @export
 * @interface UltimateDebtorProperty
 */
export interface UltimateDebtorProperty {
    /**
     * Must be a UK BBAN.
     * @type {string}
     * @memberof UltimateDebtorProperty
     */
     ...
     * @memberof UltimateDebtorProperty
     */
    'account-number-code': UltimateDebtorPropertyAccountNumberCodeEnum;
    /**
     ...
     * @memberof UltimateDebtorProperty
     */
    'bank-id-code': UltimateDebtorPropertyBankIdCodeEnum;
    /**
...
type UltimateDebtorPropertyAccountNumberCodeEnum = 'bban'
type UltimateDebtorPropertyBankIdCodeEnum = 'gbdsc'
