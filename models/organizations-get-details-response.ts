...
import { Role4 } from './role4';

/**
 * 
 * @export
 * @interface OrganizationsGetDetailsResponse
 */
export interface OrganizationsGetDetailsResponse {
    /**
     ...
     * @type {string}
     * @memberof OrganizationsGetDetailsResponse
     */
     ...
     * @memberof OrganizationsGetDetailsResponse
     */
    'organization-mode': OrganizationsGetDetailsResponseOrganizationModeEnum;
    /**
     * Link to the [memberships](http://docs.griffin.com) for this [organization](http://docs.griffin.com).
     * @type {string}
     * @memberof OrganizationsGetDetailsResponse
     */
    'organization-memberships-url': string;
    /**
     ...
     * @memberof OrganizationsGetDetailsResponse
     */
    'organization-invitations-url': string;
    /**
     ...
     * @memberof OrganizationsGetDetailsResponse
     */
    'organization-api-keys-url': string;
    /**
     * Link to the resource that enables you to request live access.
     * @type {string}
     * @memberof OrganizationsGetDetailsResponse
     */
    'organization-live-access-url': string;
    /**
     ...
     * @memberof OrganizationsGetDetailsResponse
     */
    'organization-individuals-url': string;
    /**
     * 
     * @type {string}
     * @memberof OrganizationsGetDetailsResponse
     */
    'organization-corporations-url': string;
    /**
     ...
     * @memberof OrganizationsGetDetailsResponse
     */
    'organization-events-url': string;
}

type OrganizationsGetDetailsResponseOrganizationModeEnum = 'test-mode' | 'live-mode'
