...
import { TradingAddressProperty6 } from './trading-address-property6';

/**
 * 
 * @export
 * @interface SoleTrader4
 */
export interface SoleTrader4 {
    /**
     * 
     * @type {string}
     * @memberof SoleTrader4
     */
    'trading-name': string;
    /**
     * 
     ...
     * @memberof SoleTrader4
     */
    'trading-address': TradingAddressProperty6;
    /**
     * 
     * @type {string}
     * @memberof SoleTrader4
     */
    'claim-type': SoleTrader4ClaimTypeEnum;
}

type SoleTrader4ClaimTypeEnum = 'sole-trader'
