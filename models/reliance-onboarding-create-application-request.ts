...
import { SubjectProfileProperty } from './subject-profile-property';

/**
 * 
 * @export
 * @interface RelianceOnboardingCreateApplicationRequest
 */
export interface RelianceOnboardingCreateApplicationRequest {
    /**
     * A link to the [workflow](http://docs.griffin.com).
     * @type {string}
     * @memberof RelianceOnboardingCreateApplicationRequest
     */
    'workflow-url': string;
    /**
     * 
     * @type {SubjectProfileProperty}
     * @memberof RelianceOnboardingCreateApplicationRequest
     */
    'subject-profile': SubjectProfileProperty;
    /**
     * A list profiles related to the subject (e.g. directors, person with significant control).
     * @type {Array<RelatedProfile>}
     * @memberof RelianceOnboardingCreateApplicationRequest
     */
    'related-profiles'?: Array<RelatedProfile>;
}
