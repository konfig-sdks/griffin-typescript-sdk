 ...
 * @export
 * @interface AccountBalanceProperty2
 */
export interface AccountBalanceProperty2 {
    /**
     * 
     * @type {string}
     * @memberof AccountBalanceProperty2
     */
    'currency': AccountBalanceProperty2CurrencyEnum;
    /**
...
type AccountBalanceProperty2CurrencyEnum = 'GBP'
