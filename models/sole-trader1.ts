...
import { TradingAddressProperty } from './trading-address-property';

/**
 * 
 * @export
 * @interface SoleTrader1
 */
export interface SoleTrader1 {
    /**
     * 
     * @type {string}
     * @memberof SoleTrader1
     */
    'trading-name': string;
    /**
     * 
     ...
     * @memberof SoleTrader1
     */
    'trading-address': TradingAddressProperty;
    /**
     * 
     * @type {string}
     * @memberof SoleTrader1
     */
    'claim-type': SoleTrader1ClaimTypeEnum;
}

type SoleTrader1ClaimTypeEnum = 'sole-trader'
