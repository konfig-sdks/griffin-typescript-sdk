...
import { DirectorProperty } from './director-property';
import { PscProperty } from './psc-property';

/**
 * The relationship with the subject profile.
 * @export
 * @interface SubjectAssociationProperty
 */
export interface SubjectAssociationProperty {
    /**
     * 
     * @type {DirectorProperty}
     * @memberof SubjectAssociationProperty
     */
