 ...
 * 
 * @export
 * @interface CompanyWebsite1
 */
export interface CompanyWebsite1 {
    /**
     * 
     * @type {string}
     * @memberof CompanyWebsite1
     */
    'website-url': string;
    /**
     * 
     ...
     * @memberof CompanyWebsite1
     */
    'claim-type': CompanyWebsite1ClaimTypeEnum;
}

type CompanyWebsite1ClaimTypeEnum = 'company-website'
