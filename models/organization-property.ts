...
export interface OrganizationProperty {
     ...
     * @memberof OrganizationProperty
     */
    'organization-mode': OrganizationPropertyOrganizationModeEnum;
    /**
...
type OrganizationPropertyOrganizationModeEnum = 'test-mode' | 'live-mode'
