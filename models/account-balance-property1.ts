 ...
 * @export
 * @interface AccountBalanceProperty1
 */
export interface AccountBalanceProperty1 {
    /**
     * 
     * @type {string}
     * @memberof AccountBalanceProperty1
     */
    'currency': AccountBalanceProperty1CurrencyEnum;
    /**
...
type AccountBalanceProperty1CurrencyEnum = 'GBP'
