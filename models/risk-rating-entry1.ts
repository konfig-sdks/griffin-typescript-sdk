 ...
 * 
 * @export
 * @interface RiskRatingEntry1
 */
export interface RiskRatingEntry1 {
    /**
     * A contextual link to the risk rating.
     * @type {string}
     * @memberof RiskRatingEntry1
     */
    'risk-rating-url': string;
    /**
     * 
     * @type {string}
     * @memberof RiskRatingEntry1
     */
    'risk-rating': RiskRatingEntry1RiskRatingEnum;
    /**
     ...
     * @memberof RiskRatingEntry1
     */
    'previous-risk-rating'?: RiskRatingEntry1PreviousRiskRatingEnum;
}

type RiskRatingEntry1RiskRatingEnum = 'high-risk' | 'prohibited-risk' | 'medium-risk' | 'low-risk'
type RiskRatingEntry1PreviousRiskRatingEnum = 'high-risk' | 'prohibited-risk' | 'medium-risk' | 'low-risk'
