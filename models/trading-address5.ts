 ...
 * 
 * @export
 * @interface TradingAddress5
 */
export interface TradingAddress5 {
    /**
     * 
     * @type {object}
     * @memberof TradingAddress5
     */
     ...
     * @memberof TradingAddress5
     */
    'claim-type': TradingAddress5ClaimTypeEnum;
}

type TradingAddress5ClaimTypeEnum = 'trading-address'
