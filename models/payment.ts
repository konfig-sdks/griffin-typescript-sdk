...
import { CreditorProperty1 } from './creditor-property1';
import { DebtorProperty } from './debtor-property';
import { PaymentAmountProperty1 } from './payment-amount-property1';
import { UltimateDebtorProperty } from './ultimate-debtor-property';
...
export interface Payment {
    /**
     * 
     * @type {CreditorProperty1}
     * @memberof Payment
     */
    'creditor': CreditorProperty1;
    /**
     * Whether the payment is moving money into or out of the account.
     * @type {string}
     * @memberof Payment
     */
    'payment-direction': PaymentPaymentDirectionEnum;
    /**
    ...
    /**
     * 
     * @type {PaymentAmountProperty1}
     * @memberof Payment
     */
    'payment-amount': PaymentAmountProperty1;
    /**
     * 
     * @type {UltimateDebtorProperty}
     * @memberof Payment
     */
    'ultimate-debtor'?: UltimateDebtorProperty;
    /**
     ...
     * @memberof Payment
     */
    'debtor': DebtorProperty;
}

type PaymentPaymentDirectionEnum = 'inbound-payment' | 'outbound-payment'
