 ...
 * 
 * @export
 * @interface CompanyTelephoneNumber1
 */
export interface CompanyTelephoneNumber1 {
    /**
     * 
     * @type {any}
     * @memberof CompanyTelephoneNumber1
     */
     ...
     * @memberof CompanyTelephoneNumber1
     */
    'claim-type': CompanyTelephoneNumber1ClaimTypeEnum;
}

type CompanyTelephoneNumber1ClaimTypeEnum = 'company-telephone-number'
