 ...
 * @export
 * @interface BalanceChangeProperty
 */
export interface BalanceChangeProperty {
    /**
     * 
     * @type {string}
     * @memberof BalanceChangeProperty
     */
    'currency': BalanceChangePropertyCurrencyEnum;
    /**
...
type BalanceChangePropertyCurrencyEnum = 'GBP'
