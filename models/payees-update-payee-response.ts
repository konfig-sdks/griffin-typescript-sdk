 ...
 * 
 * @export
 * @interface PayeesUpdatePayeeResponse
 */
export interface PayeesUpdatePayeeResponse {
    /**
     * Link to the [payee](http://docs.griffin.com).
     * @type {string}
     * @memberof PayeesUpdatePayeeResponse
     */
    'payee-url': string;
    /**
     * Must be a UK BBAN.
     ...
     * @memberof PayeesUpdatePayeeResponse
     */
    'payee-status': PayeesUpdatePayeeResponsePayeeStatusEnum;
    /**
...
type PayeesUpdatePayeeResponsePayeeStatusEnum = 'deactivated' | 'active'
