 ...
 * @export
 * @interface AccountBalanceProperty6
 */
export interface AccountBalanceProperty6 {
    /**
     * 
     * @type {string}
     * @memberof AccountBalanceProperty6
     */
    'currency': AccountBalanceProperty6CurrencyEnum;
    /**
...
type AccountBalanceProperty6CurrencyEnum = 'GBP'
