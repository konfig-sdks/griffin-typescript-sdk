...
import { OrganizationProperty2 } from './organization-property2';
import { Role9 } from './role9';
import { UserProperty2 } from './user-property2';
 ...
 */
export interface Membership1 {
    /**
     * Link to the [membership](http://docs.griffin.com).
     * @type {string}
     * @memberof Membership1
     */
    'membership-url': string;
    /**
     * Link to the assigned [roles](http://docs.griffin.com) for this [membership](http://docs.griffin.com).
     * @type {string}
     * @memberof Membership1
     */
    'membership-roles-url': string;
    /**
     * 
     * @type {OrganizationProperty2}
     * @memberof Membership1
     */
    'organization': OrganizationProperty2;
    /**
