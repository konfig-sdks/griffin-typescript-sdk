 ...
 * 
 * @export
 * @interface LegalPersonHistoryListEventsResponse
 */
export interface LegalPersonHistoryListEventsResponse {
    /**
     * 
     * @type {Array<HistoryEvent>}
     * @memberof LegalPersonHistoryListEventsResponse
     */
    'legal-person-history': Array<HistoryEvent>;
    /**
     * 
     * @type {LinksProperty}
     * @memberof LegalPersonHistoryListEventsResponse
