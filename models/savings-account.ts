...
export interface SavingsAccount {
     ...
     * @memberof SavingsAccount
     */
    'savings-type': SavingsAccountSavingsTypeEnum;
    /**
     ...
     * @memberof SavingsAccount
     */
    'bank-product-type': SavingsAccountBankProductTypeEnum;
}

type SavingsAccountSavingsTypeEnum = 'easy-access'
type SavingsAccountBankProductTypeEnum = 'savings-account'
