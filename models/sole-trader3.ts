...
import { TradingAddressProperty4 } from './trading-address-property4';

/**
 * 
 * @export
 * @interface SoleTrader3
 */
export interface SoleTrader3 {
    /**
     * 
     * @type {string}
     * @memberof SoleTrader3
     */
    'trading-name': string;
    /**
     * 
     ...
     * @memberof SoleTrader3
     */
    'trading-address': TradingAddressProperty4;
    /**
     * 
     * @type {string}
     * @memberof SoleTrader3
     */
    'claim-type': SoleTrader3ClaimTypeEnum;
}

type SoleTrader3ClaimTypeEnum = 'sole-trader'
