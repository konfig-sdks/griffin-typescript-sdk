 ...
 * 
 * @export
 * @interface AnnualTurnoverProperty3
 */
export interface AnnualTurnoverProperty3 {
    /**
     * 
     * @type {string}
     * @memberof AnnualTurnoverProperty3
     */
    'currency': AnnualTurnoverProperty3CurrencyEnum;
    /**
...
type AnnualTurnoverProperty3CurrencyEnum = 'GBP'
