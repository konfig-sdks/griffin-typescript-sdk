 ...
 * 
 * @export
 * @interface UkCompanyRegister1
 */
export interface UkCompanyRegister1 {
    /**
     * 
     * @type {any}
     * @memberof UkCompanyRegister1
     */
    'email-address'?: any;
    /**
     * 
     ...
     * @memberof UkCompanyRegister1
     */
    'claim-type': UkCompanyRegister1ClaimTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof UkCompanyRegister1
     ...
     * @memberof UkCompanyRegister1
     */
    'corporation-type': UkCompanyRegister1CorporationTypeEnum;
    /**
     * 
     * @type {any}
     * @memberof UkCompanyRegister1
