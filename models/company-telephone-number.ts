 ...
 * 
 * @export
 * @interface CompanyTelephoneNumber
 */
export interface CompanyTelephoneNumber {
    /**
     * 
     * @type {any}
     * @memberof CompanyTelephoneNumber
     */
     ...
     * @memberof CompanyTelephoneNumber
     */
    'claim-type': CompanyTelephoneNumberClaimTypeEnum;
}

type CompanyTelephoneNumberClaimTypeEnum = 'company-telephone-number'
