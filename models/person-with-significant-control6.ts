 ...
 * 
 * @export
 * @interface PersonWithSignificantControl6
 */
export interface PersonWithSignificantControl6 {
    /**
     * A contextual link to the [legal person](http://docs.griffin.com).
     * @type {string}
     * @memberof PersonWithSignificantControl6
     */
     ...
     * @memberof PersonWithSignificantControl6
     */
    'claim-type': PersonWithSignificantControl6ClaimTypeEnum;
}

type PersonWithSignificantControl6ClaimTypeEnum = 'person-with-significant-control'
