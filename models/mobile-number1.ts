 ...
 * 
 * @export
 * @interface MobileNumber1
 */
export interface MobileNumber1 {
    /**
     * 
     * @type {any}
     * @memberof MobileNumber1
     */
    'mobile-number': any;
    /**
     * 
     ...
     * @memberof MobileNumber1
     */
    'claim-type': MobileNumber1ClaimTypeEnum;
}

type MobileNumber1ClaimTypeEnum = 'mobile-number'
