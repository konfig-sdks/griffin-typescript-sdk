 ...
 * 
 * @export
 * @interface TradingAddress1
 */
export interface TradingAddress1 {
    /**
     * 
     * @type {TradingAddressProperty1}
     * @memberof TradingAddress1
     */
    'trading-address': TradingAddressProperty1;
    /**
     * 
     * @type {string}
     * @memberof TradingAddress1
     */
    'claim-type': TradingAddress1ClaimTypeEnum;
}

type TradingAddress1ClaimTypeEnum = 'trading-address'
